...
description: Découvrez comment utiliser le [!UICONTROL compositeur d’expérience visuelle] (VEC) pour créer des activités de test A/B d’[!UICONTROL affectation automatique].
...
1. Créez de nouvelles expériences en modifiant les éléments de la page.
   ...
   Pour plus d’informations sur l’ajout et la modification d’expériences dans le [!UICONTROL compositeur d’expérience visuelle], voir [Ajouter une expérience](/help/main/c-activities/t-test-ab/t-test-create-ab/ab-add-experience.md#task_454646F2895242D3B92DC395A0CE1A00). Pour modifier l’[!UICONTROL expérience B], commencez par l’étape 2.
...
1. (Conditionnel) Cliquez sur la commande **[!UICONTROL Tous les visiteurs]** pour sélectionner une autre audience pour l’activité.
   ...
   1. Dans la boîte de dialogue [!UICONTROL Ajouter une audience], [sélectionnez l’audience souhaitée](/help/main/c-activities/t-test-ab/t-test-create-ab/ab-audience.md) puis cliquez sur **[!UICONTROL Attribuer l’audience]**.
      ...
      * **Cette activité uniquement** : créez une [audience spécifique à une activité](/help/main/c-target/creating-activity-only-audience.md) qui n’est pas enregistrée dans la [!UICONTROL bibliothèque d’audiences] et qui ne peut être utilisée que dans l’activité en cours
...
1. Cliquez sur le contrôle **[!UICONTROL Allocation du trafic]**, puis choisissez la méthode d’affectation du trafic souhaitée dans le volet de droite. Dans ce scénario, cliquez sur **[!UICONTROL Affectation automatique pour obtenir une expérience optimale]**.

   ![Paramètres de la méthode d’affectation du trafic](/help/main/c-activities/automated-traffic-allocation/assets/auto-allocate-to-best-exp.png)
...
1. Spécifiez les [objectifs et paramètres](/help/main/c-activities/t-test-ab/t-test-create-ab/ab-goals-and-settings.md) pour l’activité.
   ...
   >
   >Si vous souhaitez utiliser les [[!DNL Target] rapports dans [!DNL Adobe Customer Journey Analytics]](/help/main/c-integrating-target-with-mac/cja/target-reporting-in-cja.md) avec cette activité, reportez-vous à [cette page](/help/main/c-integrating-target-with-mac/cja/target-reporting-in-cja.md#create-an-activity-that-uses-customer-journey-analytics-as-the-reporting-source).
