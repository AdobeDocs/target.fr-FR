...
description: Découvrez comment utiliser le compositeur d’expérience visuelle (VEC) dans Adobe [!DNL Target] pour créer une activité de test A/B d’affectation automatique directement sur une [!DNL Target]-enabled .
...
>[!NOTE]
>
>En plus de la variable [!UICONTROL Affectation automatique] [!UICONTROL Test A/B] activité (abordée dans le présent article), [!DNL Target] fournit deux types supplémentaires de [!UICONTROL Test A/B] activités : [!UICONTROL Manuel (par défaut)] et [!UICONTROL Ciblage automatique].
>
