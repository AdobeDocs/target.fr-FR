...
description: Découvrez comment les activités dans [!DNL Target] vous permet de personnaliser le contenu pour des audiences spécifiques et de tester des conceptions de page.
...
Activités dans [!DNL Adobe Target] vous permet de personnaliser le contenu pour des audiences spécifiques et de tester des conceptions de page.
...
La variable [!UICONTROL Activities] list est la vue par défaut lorsque vous ouvrez [!DNL Target]. Vous pouvez créer des activités à partir de cette page et gérer les activités existantes.

Vous pouvez également afficher la variable [!UICONTROL Activities] en cliquant sur la [!UICONTROL Activities] dans la partie supérieure de la [!DNL Target] Interface utilisateur.

![Liste des activités](/help/main/c-activities/assets/activities-list-new.png)

La variable [!UICONTROL Activities] propose un aperçu de toutes les activités et vous permet d’effectuer diverses opérations :
...
| [!UICONTROL Show filters] icon<P>![Icône Afficher les filtres](/help/main/c-activities/assets/show-filters-icon.png) | Pour accéder aux filtres, cliquez sur le bouton **[!UICONTROL Show Filters]** en haut de la liste.<P>Pour plus d’informations, voir [Application de filtres à la liste des activités](#filters) ci-dessous |
| Zone de recherche | Recherchez rapidement une activité ou réduisez le nombre d’activités affichées dans la variable [!UICONTROL Activity] liste. Vous pouvez effectuer une recherche par [!UICONTROL Name], [!UICONTROL URL], ou [!UICONTROL ID]. |
...
| [!UICONTROL Name] | Nom de l’activité. Cliquez sur le nom d’une activité pour afficher le rapport [!UICONTROL Overview] page. <P>Cliquez sur le bouton **[!UICONTROL Quick Info]** en regard de chaque nom d’activité pour afficher plus d’informations sur cette activité dans une carte contextuelle.<p>Cliquez sur le bouton **[!UICONTROL More actions]** icône (points de suspension horizontaux) en regard de chaque nom d’activité pour ouvrir un menu vous permettant d’exécuter des actions rapides sur une activité. Les actions suivantes sont disponibles (en fonction de vos autorisations et de l’état de l’activité) : [!UICONTROL Edit], [!UICONTROL Activate], [!UICONTROL Deactivate], [!UICONTROL Copy], [!UICONTROL Delete], et [!UICONTROL Archive]. Pour plus d’informations sur chaque action, voir [Exécution d’actions rapides](#quick-actions) ci-dessous<P>Cliquez sur l’en-tête du tableau pour trier la liste par ordre alphabétique croissant ou décroissant par nom. |
| [!UICONTROL Status] | L’état d’une activité peut être l’un des suivants :<ul><li>**En cours** : l’activité est en cours d’exécution.</li><li>**Version préliminaire**: la configuration de l’activité a commencé, mais elle se trouve dans [mode brouillon](/help/main/c-activities/edit-activity.md) et n’est pas encore prêt à s’exécuter.</li><li>**Planifiée** : l’activité est prête à être activée aux heure et date spécifiées.</li><li>**Inactive** : l’activité a été interrompue ou désactivée.</li><li>**Synchronisation**: l’activité a été enregistrée et synchronisée avec la variable [!DNL Target] réseau de diffusion.</li><li>**Terminé**: la date et l’heure de fin spécifiées de l’activité ont été atteintes et l’activité n’est plus en cours de diffusion.</li><li>**Archivé** : l’activité a été archivée. Vous pouvez activer une activité archivée pour l’utiliser à nouveau.</li></ul>**Remarque**: lorsque vous effectuez certaines actions, comme l’activation d’une activité en dehors de la fonction [!DNL Target] L’interface utilisateur à l’aide des méthodes de l’API, la mise à jour peut prendre jusqu’à dix minutes pour se propager à la variable [!DNL Target] Interface utilisateur. |
...
| [!UICONTROL Delete] | Permet de supprimer un brouillon d’activité ou une activité.<P>**REMARQUE :** les activités supprimées le sont définitivement. À moins d’être sûr que vous n’aurez plus besoin de cette activité, utilisez la variable [!UICONTROL Archive] action. Vous pouvez ensuite réactiver l’activité si nécessaire. |

## Considérations

Notez les détails suivants sur la variable [!UICONTROL Activity] list :

* Les activités archivées et terminées n’apparaissent pas dans la variable [!UICONTROL Activities] liste. Pour visualiser ces activités, filtrez-les à l’aide du [Icône Filtres](#filters) en haut de la liste.
* Lorsqu’une activité créée à l’origine dans [!DNL Target Classic] est désactivé ou supprimé, il est supprimé de [!DNL Target Standard/Premium]. Activités supprimées créées à l’origine dans [!DNL Target Classic] ne sont pas envoyés à la variable [!UICONTROL Archive] dossier dans [!DNL Target Standard/Premium]. La fonctionnalité du dossier Archives s’applique uniquement aux activités créées dans [!DNL Target Standard/Premium].
* Tous les types d’activité autres que [!UICONTROL Automated Personalization] (AP), [!UICONTROL Auto-Allocate], et [!UICONTROL Auto-Target] vous donner le choix d’utiliser l’une ou l’autre [!DNL Target] ou [!DNL Adobe Analytics] comme source de données. [!UICONTROL AP], [!UICONTROL Auto-Allocate], et [!UICONTROL Auto-Target] *always* use [!DNL Target] data.
...
Pour les limites supplémentaires du V[!UICONTROL isual Experience Composer] VEC, voir [Limites du compositeur d’expérience visuelle](/help/main/c-experiences/c-visual-experience-composer/experience-composer-best-practices.md#section_F33C2EA27F2E417AA036BC199DD6C721).
