...
[!DNL Adobe Target] détermine la ou les activités à diffuser sur une page différemment selon l’interface [!DNL Target] et la fonction de création d’activité utilisée ([[!UICONTROL compositeur d’expérience visuelle (VEC)]](/help/main/c-experiences/c-visual-experience-composer/visual-experience-composer.md) ou [compositeur d’expérience d’après les formulaires](/help/main/c-experiences/form-experience-composer.md)).

## [!UICONTROL Compositeur d’expérience visuelle] uniquement ou [!UICONTROL Compositeur d’expérience d’après les formulaires] à l’aide d’une requête [!DNL Target] globale uniquement {#section_4A0A317DFED345649B58B0CB5B410C8B}
...
1. [!DNL Target] tente de faire correspondre le visiteur à des activités.
   ...
   Si le visiteur figure déjà dans une activité de [!UICONTROL Test A/B] ou [!UICONTROL Test multivarié], il ou elle correspond à cette activité jusqu’à sa conversion. S’ils se trouvaient auparavant dans une activité [!UICONTROL Ciblage d’expérience], ils doivent y correspondre à nouveau. S’il respecte les règles de l’audience, alors le visiteur est dirigé vers ces activités et dans des expériences spécifiques.
...
## [!UICONTROL Compositeur d’expérience d’après les formulaires] et [!UICONTROL Compositeur d’expérience visuelle] {#section_4620253E1CE942DD830724C7822B175F}

Si votre entreprise utilise le [!UICONTROL compositeur d’expérience d’après les formulaires] *et le compositeur d’expérience visuelle* le contenu de plusieurs activités du [!UICONTROL compositeur d’expérience d’après les formulaires] et du compositeur d’expérience visuelle peut être diffusé. Auparavant, une seule activité du workflow basé sur les formulaires pouvait être diffusée. Il n’existe plus de limite au nombre d’activités basées sur les formulaires pouvant être diffusées.
...
1. [!DNL Target] tente de faire correspondre le visiteur à des activités.
   ...
   Si le visiteur figure déjà dans une activité de [!UICONTROL Test A/B] ou [!UICONTROL Test multivarié], il ou elle correspond à ce test jusqu’à sa conversion. S’ils se trouvaient auparavant dans une activité [!UICONTROL Ciblage d’expérience], ils doivent y correspondre à nouveau. S’il respecte les règles de l’audience, alors le visiteur est dirigé vers ces activités et dans des expériences spécifiques.
...
## [!UICONTROL Compositeur d’expérience d’après les formulaires] avec des requêtes [!DNL Target] non globales {#section_C3F5F09B0B2D4EF795C5929D5C426A8C}
...
>[!NOTE]
>
>Les valeurs de priorité varient en fonction de vos paramètres. Vous pouvez utiliser les paramètres hérités de [!UICONTROL Faible], [!UICONTROL Medium] ou [!UICONTROL Élevé], ou activer des priorités affinées de 0 à 999. Pour plus d’informations, voir [&#x200B; Paramètres d’activité &#x200B;](/help/main/c-activities/activity-settings.md#task_C6B2FF8374724933BE79A83549B9CD02).

Réponse : offer1

**Deux activités utilisent uniquement les offres créées dans le [!UICONTROL compositeur d’expérience visuelle] pour différents sélecteurs**
...
**Deux activités utilisent uniquement les offres créées dans le [!UICONTROL compositeur d’expérience visuelle] pour le même sélecteur**
