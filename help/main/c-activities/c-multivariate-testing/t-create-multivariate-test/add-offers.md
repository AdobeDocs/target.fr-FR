...
description: Découvrez comment utiliser le compositeur d’expérience visuelle (VEC) dans Adobe [!DNL Target] pour créer les offres que vous souhaitez inclure dans votre test multivarié (MVT).
