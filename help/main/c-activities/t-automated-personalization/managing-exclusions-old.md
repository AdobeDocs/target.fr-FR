...
Gérez les exclusions en créant des groupes d’exclusions, en excluant les offres en double, en excluant les expériences spécifiques et en excluant le contenu par défaut dans les activités  (AP) de [!DNL Adobe Target].

## Créer des groupes d’exclusion {#task_AAAA6C7239A84F7696C8492F04B575A2}

Créez des groupes d’exclusion dans les activités  (AP) pour vous assurer que les expériences avec les offres désignées sont automatiquement exclues.
...
1. Lors de la [création ou de la modification d’une activité AP](/help/main/c-activities/t-automated-personalization/create-ap-activity.md), cliquez sur **[!UICONTROL Gérer le contenu]** dans la barre d’en-tête.
...
Cliquez sur l’option d’engrenage **[!UICONTROL Configurer]** > **[!UICONTROL Dupliquer les offres]**, puis sur **[!UICONTROL Autoriser les doublons]** ou **[!UICONTROL Interdire les doublons]**.
...
Excluez des expériences spécifiques si vous souhaitez exclure certaines combinaisons d’offres de votre activité .
...
1. Excluez d’autres expériences, selon les besoins.
   ...
   Vous pouvez également exclure des expériences par lots en cochant la case correspondant aux expériences pertinentes, puis en cliquant sur l’icône **[!UICONTROL Exclure]** dans le coin supérieur droit de la boîte de dialogue. L’icône [!UICONTROL Exclure] s’affiche lorsqu’une ou plusieurs expériences sont cochées.

   ![Exclusion d’expériences par lots](/help/main/c-activities/t-automated-personalization/assets/exclude_exp_2a.png)

   Vous pouvez filtrer cette vue de liste pour n’afficher que les activités exclues ou incluses uniquement en cliquant sur la liste déroulante [!UICONTROL Statut].
...
Parfois, vous pouvez ne pas vouloir inclure votre contenu par défaut dans votre activité . La manière dont vous accédez à ce paramètre est différente par rapport à la création de groupes d’exclusion. Vous pouvez appliquer cette méthode de manière à conserver une seule offre (différente de votre contenu par défaut) à un emplacement donné dans le cadre de votre activité AP.
...
1. Lors de la [création ou modification d’une activité AP](/help/main/c-activities/t-automated-personalization/create-ap-activity.md), sélectionnez le contenu à remplacer et cliquez pour accéder à **[!UICONTROL Modifier le texte/HTML]**, **[!UICONTROL Modifier l’image]** ou **[!UICONTROL Modifier la couleur d’arrière-plan]**.
1. Dans la boîte de dialogue, créez votre nouveau contenu et désélectionnez **Inclure** à droite du contenu par défaut (ou désélectionnez l’option Image/vidéo par défaut dans l’écran [!UICONTROL Sélectionner le contenu]).

   Selon le type de contenu ou d’offre, la case à cocher [!UICONTROL Inclure] se trouve à un emplacement légèrement différent.
...
1. Cliquez sur **[!UICONTROL Enregistrer]**.
   ...
   Vous pouvez voir les expériences créées à partir des offres que vous avez spécifiées sous [!UICONTROL Gérer le contenu]. Notez qu’aucune expérience n’est créée dans [!UICONTROL Gérer le contenu] avec l’offre par défaut que vous avez exclue.

   ![image exclude_content_vec_4](assets/exclude_content_vec_4.png)

**Pour exclure le contenu par défaut à l’aide du [!UICONTROL Compositeur d’expérience d’après les formulaires]:**

1. Lors de la création ou de la modification d’une activité AP, cliquez sur **[!UICONTROL Modifier le texte/l’HTML]** ou **[!UICONTROL Modifier l’offre d’image]** sous **[!UICONTROL Contenu]**.
1. Dans la boîte de dialogue, créez votre nouveau contenu et désélectionnez **[!UICONTROL Inclure]** à droite du contenu par défaut (ou désélectionnez l’option Image/vidéo par défaut dans l’écran [!UICONTROL Sélectionner le contenu]).
