...
1. (Conditionnel) Pour exclure une ou plusieurs expériences de l’activité, cliquez sur l’icône **[!UICONTROL Exclure]**.
   ...
   Pour exclure une expérience, pointez sur l’expérience et cliquez sur l’icône **[!UICONTROL Exclure]**.
   ...
   Par défaut, toutes les expériences sont incluses dans l’activité . Pour inclure une expérience qui a été exclue, survolez-la avec la souris et cliquez sur l’icône **[!UICONTROL Inclure]**.
...
1. Cliquez sur **[!UICONTROL Composer]** pour revenir au [!UICONTROL Compositeur d’expérience visuelle] afin de pouvoir apporter des modifications supplémentaires, ou cliquez sur **[!UICONTROL Suivant]** pour passer à l’étape [!UICONTROL Ciblage].
