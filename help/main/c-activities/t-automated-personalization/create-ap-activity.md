...
description: Découvrez comment créer une activité [!UICONTROL Automated Personalization] (AP) dans  [!DNL Adobe Target]  à l’aide de [!UICONTROL Visual Experience Composer].
...
1. Vérifiez ou saisissez l’URL d’activité, puis cliquez sur **[!UICONTROL Create]**.
