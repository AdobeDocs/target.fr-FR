...
description: Gestion des exclusions dans Adobe [!DNL Target] Activités Automated Personalization (AP). Créez des groupes d’exclusion et excluez les offres en double, les expériences spécifiques et le contenu par défaut.
...
# ![Badge Premium](/help/main/assets/premium.png) Gestion des exclusions

Gestion des exclusions en créant des groupes d’exclusion, à l’exclusion des offres en double, des expériences spécifiques et du contenu par défaut dans [!UICONTROL Automated Personalization] (AP) dans [!DNL Adobe Target] [!UICONTROL Automated Personalization] (AP).
