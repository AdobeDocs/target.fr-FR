...
description: Gestion des exclusions dans [!DNL Adobe Target] [!UICONTROL Automated Personalization] (AP). Créez des groupes d’exclusion et excluez les offres en double, les expériences spécifiques et le contenu par défaut.
title: Comment gérer les exclusions dans [!UICONTROL Automated Personalization] Activités ?
...
Gestion des exclusions en créant des groupes d’exclusion, à l’exclusion des offres en double, des expériences spécifiques et du contenu par défaut dans [!UICONTROL Automated Personalization] (AP) dans [!DNL Adobe Target].

## Création de groupes d’exclusion {#task_AAAA6C7239A84F7696C8492F04B575A2}

Création de groupes d’exclusion dans [!UICONTROL Automated Personalization] (AP) pour s’assurer que les expériences avec les offres désignées sont automatiquement exclues.
...
1. Dans le [!UICONTROL Gestion du contenu] , cliquez sur **[!UICONTROL Groupes d’exclusion]**.
...
Cliquez sur le bouton **[!UICONTROL Configurer]** option d’équipement > **[!UICONTROL Duplication d’offres]**, puis cliquez sur **[!UICONTROL Autoriser les doublons]** ou **[!UICONTROL Interdire les doublons]**.
...
Excluez des expériences spécifiques si vous souhaitez exclure certaines combinaisons d’offres de votre [!UICONTROL Automated Personalization] activité.
...
1. Excluez d’autres expériences, selon les besoins.
   ...
   Vous pouvez également exclure des expériences par lots en cochant la case correspondant aux expériences pertinentes, puis en cliquant sur le bouton **[!UICONTROL Exclure]** dans le coin supérieur droit de la boîte de dialogue. La variable [!UICONTROL Exclure] s’affiche lorsqu’une ou plusieurs expériences sont cochées.
   ...
   Les expériences sont désormais exclues de l’activité et de leur [!UICONTROL État] Afficher sous [!UICONTROL Exclu].

   ![Expériences exclues](/help/main/c-activities/t-automated-personalization/assets/exclude_exp_3a.png)

## Exclusion du contenu par défaut {#task_DCB4528989DF4C05A3A4729E5891D18F}

Parfois, vous pouvez ne pas vouloir inclure votre contenu par défaut dans votre [!UICONTROL Automated Personalization] activité. La manière dont vous accédez à ce paramètre est différente par rapport à la création de groupes d’exclusion. Vous pouvez appliquer cette méthode de manière à conserver une seule offre (différente de votre contenu par défaut) à un emplacement donné dans le cadre de votre activité AP.
...
1. while [création ou modification d’une activité AP](/help/main/c-activities/t-automated-personalization/create-ap-activity.md), sélectionnez le contenu à remplacer, puis cliquez pour accéder à **[!UICONTROL Modifier le texte/HTML]**, **[!UICONTROL Modifier l’image]**, ou **[!UICONTROL Modifier la couleur d’arrière-plan]**.
1. Dans la boîte de dialogue, créez votre nouveau contenu et désélectionnez la case **Inclure** à droite du contenu par défaut (ou ne cochez pas l’image/vidéo par défaut dans l’écran Sélection de contenu).
   ...
   Selon le contenu ou le type d’offre, la variable [!UICONTROL Inclure] se trouve à un endroit légèrement différent.
...
1. Cliquez sur **[!UICONTROL Enregistrer]**.
   ...
   Vous pouvez voir les expériences créées à partir des offres que vous avez spécifiées sous [!UICONTROL Gérer le contenu]. Vous remarquerez qu’aucune expérience n’est créée dans [!UICONTROL Gestion du contenu] en utilisant l’offre par défaut que vous avez exclue.

   ![image exclude_content_vec_4](assets/exclude_content_vec_4.png)

**Pour exclure le contenu par défaut à l’aide de la propriété [!UICONTROL Compositeur d’expérience d’après les formulaires]:**
