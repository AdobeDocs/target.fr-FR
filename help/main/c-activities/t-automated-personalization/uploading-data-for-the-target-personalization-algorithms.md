...
description: Découvrez comment charger des données hors ligne lors de la création de modèles de personnalisation dans les activités  [!DNL Adobe Target]  (AP) et [!UICONTROL Ciblage automatique].
