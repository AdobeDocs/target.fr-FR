...
description: Découvrez comment utiliser les activités [!UICONTROL ] (AP) dans qui utilisent le machine learning avancé pour faire correspondre différentes variations d [!DNL Adobe Target] offre pour chaque visiteur.
