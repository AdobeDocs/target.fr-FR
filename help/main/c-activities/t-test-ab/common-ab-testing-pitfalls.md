---
keywords: AB;A/B;AB...n;erreurs;écueils;erreur;piège;signification;gagnant;différence statistique;statistique;puissance statistique;affectation du trafic;affectation;
description: Découvrez comment éviter les écueils et les erreurs les plus courants des entreprises lors de l’exécution de tests A/B dans Adobe [!DNL Target] et d’autres solutions de test.
...
Tests A/B dans [!DNL Adobe Target] constitue l’épine dorsale de la plupart des programmes d’optimisation du marketing numérique, ce qui permet aux marketeurs d’offrir à leurs visiteurs et à leurs clients des expériences optimisées et ciblées. Cette section décrit dix des écueils les plus significatifs auxquels les entreprises sont confrontées lorsqu’elles effectuent des tests A/B. Elle décrit également des moyens de les éviter, de sorte que votre entreprise puisse accroître son retour sur investissement au moyen de tests et optimiser le degré de confiance des résultats des tests A/B.

## Piège 1 : Ignorer les effets du niveau de pertinence {#section_55F5577A13C6470BA1417C2B735C6B1D}
...
## Piège 2 : Déclarer les gagnants de plusieurs tests d’offre sans différence statistiquement significative {#section_FA83977C71DB4F69B3D438AF850EF3B6}
...
## Étape 4 : Utilisation de tests unilatéraux {#section_8BB136D1DD6341FA9772F4C31E9AA37C}
...
## Pièce 5 : Surveillance des tests {#section_EA42F8D5967B439284D863C46706A1BA}
...
## Piège 6 : Arrêt prématuré des tests {#section_DF01A97275E44CA5859D825E0DE2F49F}
...
Nous vous recommandons de ne pas modifier les pourcentages d’affectation du trafic au cours de la période de test, car cela peut biaiser les résultats de test jusqu’à la normalisation des données.
...
Si vous modifiez manuellement la répartition de l’affectation à 100 % pour l’expérience B, les visiteurs qui ont été affectés à l’origine à l’expérience A (le contrôle) restent dans l’expérience initialement affectée (expérience A). Le changement de l’affectation du trafic n’affecte que les nouveaux entrants.
...
Si vous modifiez les pourcentages pour différentes expériences au cours de la période de test, la normalisation des données prend quelques jours, en particulier si de nombreux acheteurs sont des visiteurs récurrents.
Autre exemple : si l’affectation du trafic de votre test A/B est fractionnée 50/50, puis que vous définissez la répartition sur 80/20, les résultats peuvent être biaisés pendant les premiers jours suivant cette modification. Si la durée moyenne de conversion est élevée, ce qui signifie qu’il faut plusieurs heures, voire plusieurs jours à quelqu’un pour effectuer un achat, ces conversions différées peuvent affecter vos rapports. Ainsi, dans cette première expérience où le nombre est passé de 50 % à 80 % et où la durée moyenne de conversion est de deux jours, seuls les visiteurs provenant de 50 % de la population effectuent une conversion le premier jour du test, bien qu’aujourd’hui, 80 % de la population participe à l’expérience. Cela donne l’impression que le taux de conversion a chuté, mais il se normalisera à nouveau une fois que ces 80 % des visiteurs auront mis deux jours à se convertir.

## Pièce 8 : Ne pas prendre en compte les effets de nouveauté {#section_90F0D24C40294A8F801B1A6D6DEF9003}
...
## Pièce 9 : Ne pas tenir compte des différences dans la période de considération {#section_B166731B5BEE4E578816E351ECDEA992}
...
## Pièce 10 : Utiliser des mesures qui ne reflètent pas les objectifs de l’entreprise {#section_F0CD6DC7993B4A6F9BEEBB31CD1D9BEE}
