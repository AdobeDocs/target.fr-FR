...
description: Utilisez le [!UICONTROL compositeur d’expérience visuelle] (VEC) pour ajouter des expériences aux activités.
...
1. Sur la page **[!UICONTROL Expériences]** du compositeur d’expérience visuelle, cliquez sur l’icône [!UICONTROL Ajouter] ( ![icône Ajouter](/help/main/assets/icons/Add.svg) ) en haut du volet [!UICONTROL Expériences].
...
1. Cliquez sur **[!UICONTROL Suivant]** lorsque vous avez terminé de concevoir l’expérience.

## Renommer l’expérience

1. Cliquez sur l’icône **[!UICONTROL Renommer l’expérience]** ( ![Icône Renommer](/help/main/assets/icons/Rename.svg) ) en regard d’une expérience pour lui donner un nouveau nom.

2. Indiquez un nouveau nom, puis cliquez sur **[!UICONTROL Enregistrer]**.
...
1. Dans le volet **[!UICONTROL Expériences]**, cliquez sur l’icône **[!UICONTROL Plus]** ( ![Icône Plus](/help/main/assets/icons/MoreSmall.svg) ) en regard d’une expérience, puis cliquez sur **[!UICONTROL Rediriger vers l’URL]**.
...
Vous pouvez copier une expérience dans un test [!UICONTROL A/B] afin d’y apporter des modifications mineures sans avoir à recréer l’expérience.

1. Dans le volet **[!UICONTROL Expériences]**, cliquez sur l’icône **[!UICONTROL Plus]** ( ![Icône Plus](/help/main/assets/icons/MoreSmall.svg) ) en regard d’une expérience, puis cliquez sur **[!UICONTROL Dupliquer]**.

## Suppression d’une expérience

1. Dans le volet **[!UICONTROL Expériences]**, cliquez sur l’icône **[!UICONTROL Plus]** ( ![Icône Plus](/help/main/assets/icons/MoreSmall.svg) ) en regard d’une expérience, cliquez sur **[!UICONTROL Supprimer]**, puis sur **[!UICONTROL Supprimer]** pour confirmer l’action.
