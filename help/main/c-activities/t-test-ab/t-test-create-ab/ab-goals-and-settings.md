...
description: Découvrez comment utiliser la page [!UICONTROL Goals and Settings] pour spécifier des informations sur les objectifs d’une activité A/B.
...
La section [!UICONTROL Advanced Settings] de la page [!UICONTROL Goals & Settings] vous permet de configurer les options suivantes :

Pour spécifier des paramètres avancés, cliquez sur l’icône **[!UICONTROL More]** (points de suspension verticaux), puis cliquez sur **[!UICONTROL Advanced Settings]**, comme illustré ci-dessous.
