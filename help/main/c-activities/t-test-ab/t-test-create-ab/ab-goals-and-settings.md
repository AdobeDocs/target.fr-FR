...
La page Objectifs et paramètres de [!DNL Adobe Target] est l’emplacement où vous saisissez des informations sur les objectifs du test.

Les paramètres disponibles dépendent si vous utilisez Target ou [Analytics](/help/main/c-integrating-target-with-mac/a4t/a4t.md) en tant que source de données.

![Boîte de dialogue Paramètres d’activité](/help/main/c-activities/t-test-ab/t-test-create-ab/assets/ab_settings-new.png)
