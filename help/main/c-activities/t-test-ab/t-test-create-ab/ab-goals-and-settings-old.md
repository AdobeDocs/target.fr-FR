...
La section [!UICONTROL Advanced Settings] de la page [!UICONTROL Goals & Settings] permet de paramétrer les options suivantes :

Pour définir les paramètres avancés, cliquez sur l’icône **[!UICONTROL More]** (les points de suspension verticaux), puis sur **[!UICONTROL Advanced Settings]**, comme illustré ci-dessous.
