...
[!UICONTROL Activity QA] vous permet de tester entièrement votre [!DNL Target] activités avant de les lancer en direct. La variable [!UICONTROL Activity QA] Cette fonctionnalité comprend les éléments suivants :
...
* La capacité à vérifier la qualité de l’ensemble du parcours de l’utilisateur. Vous avez accès à votre site une fois avec le lien AQ et vous parcourez ensuite le site entier en mode AQ d’activité. Vous restez dans l’AQ d’activité jusqu’à ce que vous mettiez fin à la session ou que vous utilisiez la variable [signet d’applet AQ Target](/help/main/c-activities/c-activity-qa/activity-qa-bookmark.md#concept_A8A3551A4B5342079AFEED5ECF93E879) pour vous libérer de vos capacités [!UICONTROL Activity QA]. Cette fonctionnalité est utile si vous avez une activité qui s’étend sur plusieurs pages web.
...
1. À partir d’une activité [!UICONTROL Overview] page, cliquez sur **[!UICONTROL Activity QA]**.
...
1. Configurez les paramètres suivants :
   ...
   * **Afficher le contenu par défaut pour toutes les autres activités :** Si cette option est activée, le contenu par défaut s’affiche pour toutes les autres activités. Par exemple, l’aperçu s’affiche isolément sans tenir compte de toutes les autres activités actives sur la même page/[!DNL Target] requête.
      ...
      * S’il existe des collisions entre l’activité que vous testez et d’autres activités actives, [règles de priorité normale](/help/main/c-activities/priority.md#concept_1780C11FEA57440499F0047DD6900E0F) appliquez. En raison des collisions, il est possible que vous ne puissiez pas voir l’activité que vous avez l’intention de vérifier la qualité.
...
1. Partagez les URL de lien d’activité avec les membres de votre organisation pour les tests.
   ...
   Vous pouvez parcourir le site pour afficher les autres pages, car la variable [!UICONTROL Activity QA] Le mode est collant. Cette situation est vraie pour les implémentations d’at.js avec la version 2.*x* ou plus tard. Pour at.js 1.*x* Implémentations, cette situation n’est vraie que si le navigateur du visiteur ne bloque pas les cookies tiers.

1. Pour afficher les rapports générés à partir des URL de lien d’activité, cliquez sur le **[!UICONTROL Reports]** , cliquez sur **[!UICONTROL Settings]** icône (  ![image icon_engrenage](assets/icon_gear.png) ), puis sélectionnez **[!UICONTROL QA Mode Traffic]** de la **[!UICONTROL Environment]** liste déroulante.

## Se libérer du mode AQ

[!UICONTROL Activity QA] est collant. Une fois que vous avez parcouru un site web dans [!UICONTROL Activity QA], votre [!DNL Target] doit expirer ou vous devez [!DNL Target] de [!UICONTROL Activity QA] avant de pouvoir afficher votre site comme un visiteur type.

### at.js 2.*x*

Si votre site comporte at.js 2.*x* déployé, utilisez la méthode [signet d’applet AQ Target](/help/main/c-activities/c-activity-qa/activity-qa-bookmark.md#concept_A8A3551A4B5342079AFEED5ECF93E879) pour vous libérer de vos capacités [!UICONTROL Activity QA]. Le chargement d’une page de votre site avec une valeur vide, comme décrit dans la puce suivante, effectue les opérations suivantes : *not* supprimez le cookie AQ du navigateur lorsque at.js 2.*x* est déployé.

### Paramètres at.js 1.*x*

Si votre site comporte at.js 1.*x* déployé, en plus d’utiliser la variable [signet d’applet AQ Target](/help/main/c-activities/c-activity-qa/activity-qa-bookmark.md#concept_A8A3551A4B5342079AFEED5ECF93E879), vous pouvez également vous libérer manuellement en chargeant une page de votre site avec l’événement `at_preview_token` avec une valeur vide. Par exemple :

`https://www.mysite.com/?at_preview_token=`

### [!DNL Adobe Experience Platform Web SDK]

Si votre site comporte la variable [[!UICONTROL Platform Web SDK]](https://experienceleague.corp.adobe.com/docs/target-dev/developer/client-side/aep-web-sdk.html?lang=fr){target=_blank} déployé, vous pouvez manuellement vous libérer en chargeant une page de votre site avec l’événement `at_qa_mode` avec une valeur vide. Par exemple :
...
* [!UICONTROL Activity QA] les liens d’aperçu pour les activités enregistrées peuvent ne pas se charger si votre compte contient trop d’activités enregistrées. La nouvelle tentative des liens d’aperçu doit fonctionner. Pour éviter que cette situation ne se reproduise, archivez les activités enregistrées qui ne sont plus utilisées de manière active.
* [!UICONTROL Activity QA] Les URL sont disponibles avec des activités avec [Analytics comme source de création de rapports](/help/main/c-integrating-target-with-mac/a4t/a4t.md) (A4T). Accès générés lors de l’exécution de l’AQ à l’aide de [!UICONTROL Activity QA] flux vers la même suite de rapports que celle où les données de l’activité sont transmises même après activation de l’activité.
* [!UICONTROL Activity QA] n’affiche pas de contenu pour les activités archivées ou les activités dont la date de fin est dépassée. Si vous désactivez une activité terminée, vous devez enregistrer à nouveau l’activité pour [!UICONTROL Activity QA] au travail.
...
## Bibliothèque JavaScript Target [!UICONTROL QA Mode] compatibilité {#compatibility}
...
Le tableau suivant répertorie les différents types d’activité et indique si [!UICONTROL Activity QA] Le mode est pris en charge pour chaque bibliothèque :
