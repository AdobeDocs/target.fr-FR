...
1. Partagez les URL de lien d’activité avec des membres de votre organisation à des fins de test.
   ...
   Vous pouvez parcourir le site pour afficher les autres pages, car le mode [!UICONTROL Activity QA] est contigu. Cette situation est vraie pour les implémentations d’at.js avec la version 2.*x* ou ultérieure. Pour les implémentations d’at.js 1.*x*, cette situation est uniquement vraie si le navigateur du visiteur ne bloque pas les cookies tiers.
