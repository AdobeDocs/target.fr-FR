...
Pour ajuster le pourcentage de [!UICONTROL Control], cliquez sur [!UICONTROL Experiences] dans le volet [!UICONTROL Traffic Allocation], puis ajustez les pourcentages selon vos besoins. Vous ne pouvez pas diminuer le groupe de contrôle à moins de 10 %.
