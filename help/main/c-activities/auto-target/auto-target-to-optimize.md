...
description: Découvrez comment une activité [!UICONTROL Auto-Target] dans  [!DNL Target]  diffuse l’expérience la plus personnalisée à chaque visiteur selon les profils client et le comportement de visiteurs similaires.
...
Pour ajuster le pourcentage [!UICONTROL Control], cliquez sur les icônes de la colonne [!UICONTROL Allocation]. Vous ne pouvez pas diminuer le groupe de contrôle à moins de 10 %.
...
* À l’avenir, ce banc de test nous permettra d’ouvrir la plateforme d’apprentissage automatique [!DNL Adobe] à des clients à l’aise avec les données afin qu’ils puissent introduire leurs propres modèles pour augmenter les modèles [!DNL Target].
...
* Définition de [!UICONTROL Auto-Target] tests
* Comparer [!UICONTROL Auto-Target] à [!UICONTROL Automated Personalization]
* Créer des activités [!UICONTROL Auto-Target]
