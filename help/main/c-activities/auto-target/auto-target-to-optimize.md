...
description: Découvrez comment une activité de [!UICONTROL ciblage automatique] offre à chaque visiteur l’expérience la plus adaptée en fonction des profils client et du comportement de visiteurs similaires.
...
* Attention à la forme de l&#39;activité. Les performances dépendent davantage du nombre d’emplacements × d’offres que du nombre d’expériences brutes. Les combinaisons cartésiennes volumineuses peuvent ralentir le chargement et la modification dans le [!UICONTROL compositeur d’expérience visuelle], même en dessous des limites d’expérience documentées.
...
* [!UICONTROL Évaluer l’algorithme Personalization (50/50)]
* [!UICONTROL Maximiser le trafic Personalization (90/10)]
...
Pour ajuster le pourcentage [!UICONTROL Contrôle], cliquez sur [!UICONTROL Expériences] dans le volet [!UICONTROL Affectation du trafic], puis ajustez les pourcentages selon vos besoins. Vous ne pouvez pas diminuer le groupe de contrôle à moins de 10 %.
...
* À l’avenir, ce banc d’essai nous permettra d’ouvrir la plateforme de machine learning [!DNL Adobe] aux clients qui maîtrisent les données afin qu’ils puissent introduire leurs propres modèles pour compléter les modèles [!DNL Target].
