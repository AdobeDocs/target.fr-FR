...
1. Indiquez votre [URL d’activité](/help/main/c-activities/t-test-ab/t-test-create-ab/ab-activity-url.md) puis cliquez sur **[!UICONTROL Suivant]**.
...
1. Configurez l’affectation de votre trafic.
   ...
   Choisissez la méthode d’affectation du trafic souhaitée. Pour créer une activité de [!UICONTROL ciblage automatique], sélectionnez **[!UICONTROL Ciblage automatique pour les expériences personnalisées]**.
