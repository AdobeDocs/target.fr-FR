...
Pour plus d’informations, voir [Transfert de paramètres à une mbox globale](https://experienceleague.adobe.com/docs/target-dev/developer/client-side/global-mbox/pass-parameters-to-global-mbox.html){target=_blank}.
...
Le public [carte contextuelle des détails de définition](/help/main/c-target/c-audiences/audiences.md#section_11B9C4A777E14D36BA1E925021945780) affiche le nom du paramètre dans la variable **[!UICONTROL Règles]** . Il n’y a aucune référence à la mbox utilisée pour le filtrage.
