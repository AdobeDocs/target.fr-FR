...
>[!IMPORTANT]
>
>Commencer avec la méthode [!DNL Target] Standard/Premium 24.3.1 (4-6 mars 2024), audiences intégrées créées à l’aide de l’interface utilisateur de Target, telles que `Browser:iPad` et `Browser:iPhone` ont été mis à jour afin d’effectuer un ciblage correct pour [!DNL iPad] et [!DNL iPhone] using `profile.mobile.deviceVendor`, `profile.mobile.isMobilePhone`, et `profile.mobile.isTablet`.
>
>Cette mise à jour ne nécessite aucune action du côté des clients. Les libellés dans la variable [!DNL Target] L’interface utilisateur sera modifiée à l’avenir et sera annoncée dans [[!DNL Target] notes de mise à jour (actualisées)](/help/main/r-release-notes/release-notes.md) lorsque ces modifications sont apportées.
>
>Pour obtenir des paramètres de contournement, voir [Mises à jour pour [!DNL iPad] et [!DNL iPhone] in [!UICONTROL Browser] Attributs d’audience (30 avril 2024)](#updates) ci-dessous
...
* **Règle d’audience de navigateur personnalisée :** Une audience personnalisée vous permet de cibler plusieurs navigateurs ou de configurer des règles ou des exclusions pour des navigateurs, des versions de navigateur ou des langues de navigateur spécifiques. Cette fonctionnalité offre une flexibilité considérable lors du ciblage d’une activité basée sur les attributs du navigateur.
   ...
   1. Glisser-déposer **[!UICONTROL Browser]** dans le créateur d’audiences.
...
Sélectionner **[!UICONTROL Type]**, puis sélectionnez est égal à ou n’est pas égal à.

* [!UICONTROL Equals]: ciblez les navigateurs sélectionnés.
* [!UICONTROL Does not equal]: exclut les navigateurs sélectionnés.
...
Sélectionner **[!UICONTROL Language]**, puis sélectionnez est égal à ou n’est pas égal à.

* [!UICONTROL Equals]: cible les langues de navigateur sélectionnées.
* [!UICONTROL Does not equal]: exclut les langues de navigateur sélectionnées.
...
Sélectionner **[!UICONTROL Version]**, puis choisissez un opérateur :
...
## Mises à jour pour [!DNL iPad] et [!DNL iPhone] in [!UICONTROL Browser] Attributs d’audience (30 avril 2024) {#updates}
...
Audiences intégrées créées à l’aide du [!DNL Target] IU, telle que `Browser:iPad` et `Browser:iPhone`, sera automatiquement déplacé vers la nouvelle définition d’audience et ne nécessite aucune action du côté des clients. Cependant, à partir de maintenant, vous devrez utiliser les paramètres [décrit ci-dessous](#ui).
...
* **Pour les correspondances de navigateur avec iPad**: [!UICONTROL Mobile] > [!UICONTROL Device Marketing Name] [!UICONTROL matches] [!DNL iPad] avec un conteneur Et avec [!UICONTROL Mobile] > [!UICONTROL Is Tablet] is [!DNL true]

  ![iPad](/help/main/r-release-notes/assets/ipad.png)

* **Pour les correspondances de navigateur avec iPhone**: [!UICONTROL Mobile] > [!UICONTROL Device Marketing Name] [!UICONTROL matches] [!DNL iPhone] avec un conteneur Et avec [!UICONTROL Mobile] > [!UICONTROL Is Mobile Phone] is [!DNL true]
...
* **Pour le navigateur ne correspond pas à iPhone**: [!UICONTROL Mobile] > [!UICONTROL Device Vendor] [!UICONTROL does not match] [!UICONTROL Apple] avec un conteneur Ou avec [!UICONTROL Mobile] > [!UICONTROL Is Mobile Phone] is [!UICONTROL false]

  ![Pas de téléphone mobile](/help/main/r-release-notes/assets/mobile-phone-false.png)

* **Pour le navigateur ne correspond pas à iPad**: [!UICONTROL Mobile] > [!UICONTROL Device Vendor] [!UICONTROL does not match] [!UICONTROL Apple] avec un conteneur Ou avec [!UICONTROL Mobile] > [!UICONTROL Is Tablet] is [!UICONTROL false].
