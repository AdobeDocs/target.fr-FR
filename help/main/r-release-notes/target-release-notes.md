...
* Ajout de la possibilité de filtrer [!DNL Adobe Experience Manager] (AEM) [fragments d’expérience](/help/main/c-experiences/c-manage-content/aem-experience-fragments.md) par type (HTML ou JSON) dans la variable [!UICONTROL Offres] liste. (TGT-43121)
