...
Cet article contient des informations en version préliminaire pour les versions à venir d’[!DNL Adobe Target], y compris les SDK, les API et les bibliothèques JavaScript.
