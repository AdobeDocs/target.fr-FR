...
|--- |--- |--- |
| 16er juin | [[!DNL Target] création de rapports dans  [!DNL Adobe Customer Journey Analytics]](/help/main/c-integrating-target-with-mac/cja/target-reporting-in-cja.md) | Ajout d’une nouvelle section : Créer et afficher des rapports d’activité dans [!DNL Customer Journey Analytics]. |
