...
| --- | --- | --- |
| 22 mars | [Ajout des nœuds Edge de Target sur liste autorisée](https://experienceleague.adobe.com/en/docs/target-dev/developer/implementation/privacy/allowlist-edges){target=_blank} | Suppression des références aux noeuds Edge 31 à 38, car ces noeuds n’existent plus. Vérifiez que votre liste autorisée est à jour. |
|  | [Impact de l’obsolescence des cookies tiers sur Target (at.js)](https://experienceleague.adobe.com/docs/target-dev/assets/third_party_cookie_deprecation){target=_blank} | Nouvel article de blog décrivant ce que signifie l’abandon planifié des cookies tiers par Google pour votre [!DNL Adobe Target] Implémentation d’at.js. |
| 14 mars | [[!DNL Target] Notes de mise à jour (actuelles)](/help/main/r-release-notes/release-notes.md) | Ajout des notes de mise à jour pour la variable [!DNL Adobe Experience Platform Visual Editing Helper] pour [!DNL Google Chrome]. |
| 13 mars | [[!UICONTROL Time Frame]](/help/main/c-target/c-audiences/c-target-rules/time-frame.md) | Ajout d’informations à noter pour réenregistrer les audiences basées sur le temps afin de prendre en compte l’heure d’été. |
| 6 mars | [Navigateur](/help/main/c-target/c-audiences/c-target-rules/browser.md) | Mise à jour des informations dans la section suivante : &quot;Mises à jour pour [!DNL iPad] et [!DNL iPhone] in [!UICONTROL Browser] Attributs d’audience (30 avril 2024)&quot;. |
|  | [Notes de mise à jour de Target (actualisées)](/help/main/r-release-notes/release-notes.md) | Mise à jour de toute la section : &quot;Mises à jour pour `Browser:iPad` et `Browser:iPhone` in [!UICONTROL Browser] Attributs d’audience (30 avril 2024)&quot;. |
...
| Date | Rubrique | Modifications |
| --- | --- | --- |
| 28 février | Notes de mise à jour de [[!DNL Target]  (version préliminaire)](/help/main/r-release-notes/target-release-notes.md) | Ajout d’informations à propos de la variable [!DNL Target] Version Standard/Premium 24.3.1 (4-6 mars 2024). |
| 26 février | [[!DNL Adobe Target] Annonces et événements](/help/main/r-release-notes/target-announcements.md) | Ajout d’informations à propos des [!UICONTROL Adobe Target Community] Coffee Break (28 février 2024). |
...
| 22 janvier | [Notes de mise à jour de Target (actualisées)](/help/main/r-release-notes/release-notes.md) | Ajout d’informations importantes sur l’obsolescence d’iPad et d’iPhone dans la [!UICONTROL Browser] attribut audience qui nécessite des modifications de votre part avant le 30 avril 2024. |
...
| 25 octobre | [[!DNL Target] Notes de mise à jour (actuelles)](/help/main/r-release-notes/release-notes.md) | Ajout d’informations à propos de la variable [!UICONTROL Activities] Actualisation de l’interface utilisateur de la page (25 octobre 2023) |
...
|  | [Configuration de rapports A4T dans [!DNL Analysis Workspace] pour [!UICONTROL Auto-Allocate] activités](https://experienceleague.adobe.com/docs/target-learn/tutorials/integrations/set-up-a4t-reports-in-analysis-workspace-for-auto-allocate-activities.html?lang=fr){target=_blank} | Mise à jour complète du tutoriel dans *[!UICONTROL Adobe Target Tutorials]* guide. |
...
|  | [Offres](/help/main/c-experiences/c-manage-content/manage-content.md) | Ajout d’une note expliquant que les offres d’image ne font pas partie de la variable [!UICONTROL Enterprise User Permissions] modèle. |
