...
* Notifications mises à jour dans l’interface utilisateur [!DNL Target] pour informer les clients si l’importation des flux [!DNL Recommendations] échouent. (TGT-35811)
