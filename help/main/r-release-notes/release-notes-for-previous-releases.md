...
* Correction d’un problème qui entraînait le blocage des rapports pour les activités Personalization automatique pendant l’analyse. (TGT-44820)
...
* Correction d’un problème qui empêchait certains clients d’afficher la liste des activités dans le Workspace par défaut. (TGT-38526)
