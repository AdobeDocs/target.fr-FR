...
Les notes de mise à jour sont répertoriées par ordre décroissant de mois et d’année de mise à jour.
...
* **Modifier la position de la page d’informations après toutes les activités.** La position de la page **Insights** a été mise à jour pour s&#39;afficher après la page **Toutes les activités** dans la navigation. La page Toutes les activités est désormais la page par défaut de l’application cible. (TGT-54672)
...
* **Rendre le volet de navigation de gauche réductible.** La navigation de gauche est désormais réductible et extensible pour tous les onglets. Lorsque réduit, les icônes s’affichent avec des info-bulles. Lorsque cette option est développée, les icônes et le texte sont affichés. Cette amélioration offre aux utilisateurs plus d’espace d’écran lorsque cela est nécessaire tout en conservant un accès rapide aux options de navigation. (TGT-54608)
...
* **ExperienceEditorType par défaut défini sur « visuel » lorsque le back-end renvoie la valeur Null.** Ce correctif résout un problème où la valeur `experienceEditorType` était renvoyée comme nulle dans certains scénarios, ce qui provoquait un comportement inattendu dans l’interface utilisateur, car le type d’éditeur n’était pas correctement initialisé. (TGT-54690)
...
Adobe Target inclut désormais un nouveau tableau de bord d’informations qui fournit une vue de haut niveau de la façon dont votre entreprise utilise Target pour l’expérimentation et la personnalisation. Le tableau de bord présente des mesures clés telles que les activités en cours, les activités en cours et modifiées, les activités terminées, les activités publiées et les activités de test A/B. Utilisez le sélecteur de période pour explorer les tendances sur différentes périodes, y compris une vue récapitulative pour 2025. Ce tableau de bord reste disponible comme un moyen continu de suivre l&#39;adoption et l&#39;activité au fil du temps.
...
+++Afficher les détails
* **La modification de critères dans une activité a provoqué le blocage de la page.** Correction d’un problème dans l’interface utilisateur mise à jour, en raison duquel la modification des critères d’activité entraînait le blocage de la page avec des erreurs de console liées aux `useCrudActionsCtx`. L’éditeur de critères se charge et fonctionne désormais correctement, ce qui permet de modifier les activités sans interruption. (TGT-53971)
* **[!UICONTROL Message]colonne n’affichait pas les données du produit par intermittence dans l’interface utilisateur mise à jour.** Correction d’un problème dans l’interface utilisateur de [!UICONTROL Recommendations] mise à jour en raison duquel la colonne [!UICONTROL Message] dans [!UICONTROL Catalog Search] échouait par intermittence à afficher les données de produit, même si les valeurs étaient présentes dans le flux. La colonne affiche désormais systématiquement les valeurs de message correctes sur tous les produits, ce qui garantit une visibilité fiable sans nécessiter de reconfiguration manuelle des colonnes. (TGT-52777)
* **[!UICONTROL Download Recommendations Data]bouton n’est pas visible après l’enregistrement de l’activité dans l’interface utilisateur mise à jour.** Correction d’un problème dans l’interface utilisateur mise à jour en raison duquel le bouton [!UICONTROL Download Recommendations Data] n’apparaissait pas pour certaines activités enregistrées, même après un nouvel enregistrement. Le bouton s’affiche désormais de manière cohérente dans toutes les activités, ce qui garantit que les utilisateurs peuvent exporter des données de recommandation de manière fiable sans solution de contournement. (TGT-53802)
* **L’ouverture de certains produits d’une collection a renvoyé « La ressource demandée est introuvable » et il manque une option de fermeture dans le modal.** a résolu un problème dans l&#39;interface utilisateur Recommendations mise à jour où l&#39;ouverture de certains produits à partir d&#39;une collection déclenchait une erreur « La ressource demandée n&#39;a pas été trouvée » et affichait un modèle vide sans option de fermeture. La boîte de dialogue modale charge désormais correctement les détails du produit, et une option de fermeture est toujours disponible pour une sortie réussie. (TGT-53986)
...
* **La modification des critères d&#39;activité entraînait parfois un écran vide dans l&#39;interface utilisateur mise à jour.** Correction d’un problème dans l’interface utilisateur mise à jour où le fait de cliquer sur [!UICONTROL Edit Criteria in Experiences] entraînait parfois l’affichage d’un écran vide pour certaines activités. L’éditeur de critères se charge désormais de manière fiable sur toutes les activités, garantissant ainsi aux utilisateurs la possibilité de modifier sans interruption. (TGT-53961)
* **Impossible de modifier les critères de séquence dans l&#39;interface utilisateur mise à jour.** Correction d&#39;un problème dans l&#39;interface utilisateur mise à jour où la tentative de modification de [!UICONTROL Sequence Criteria] provoquait le blocage de la fenêtre contextuelle des critères lors du chargement, puis l&#39;affichage d&#39;un écran vide. L’éditeur de critères se charge désormais correctement, ce qui permet aux utilisateurs de modifier et de mettre à jour les critères de séquence sans interruption. (TGT-53985)
...
* **Les rapports MVT ne se chargent pas en raison d’[!UICONTROL Element] erreur de rapport de contribution.** Correction d&#39;un problème en raison duquel les rapports d&#39;activité MVT ne parvenaient pas à se charger dans l&#39;interface utilisateur cible, affichant l&#39;erreur « Impossible de récupérer le rapport de contribution d&#39;élément ». Les rapports s’affichent désormais correctement, assurant ainsi une visibilité complète des contributions des éléments. (TGT-53691)
...
+++Afficher les détails
* **Ajout d’un préfiltre IMS pour protéger les points d’entrée GQL de l’exposition des données entre organisations.** Correction d’une vulnérabilité de sécurité dans l’onglet Administrateur affectant les points de terminaison GraphQL licenseGroups et targetProperties. Le problème provenait de l’utilisation de l’API JIL avec un jeton de client administrateur qui pouvait être exploité pour accéder aux données de produit interorganisations. (TGT-53837)
...
* **L&#39;enregistrement des modifications dans les activités fonctionne désormais comme prévu.** a résolu un problème lié aux autorisations dans la nouvelle interface utilisateur de création qui empêchait les utilisateurs d&#39;enregistrer les modifications lors de la modification des objectifs et des paramètres avancés dans les activités. Les utilisateurs concernés ont vu un ruban d’erreur rouge et un message « Forbidden.Resource », bien qu’ils disposent d’un accès approprié. (TGT-53816)
* L&#39;interface utilisateur **VEC conserve désormais les modifications d&#39;expérience entre les vues.** Résolution de plusieurs problèmes dans le VEC mis à jour qui affectaient le développement de l’expérience. Les modifications ne persistaient pas correctement, en particulier lors de l’utilisation d’offres de HTML ou du basculement entre les vues. (TGT-53825)
...
* Le mode **[!UICONTROL Design]dans le VEC bloque désormais la navigation par lien pour les composants modifiables.** Correction d’un problème dans le VEC mis à jour où les éléments cliquables, tels que les boutons et les liens, déclenchaient la redirection de page même en mode [!UICONTROL Design]. Ce comportement imitait le mode [!UICONTROL Browse] et empêchait les utilisateurs de modifier les composants clés. (TGT-53696)
* La mesure **« [!UICONTROL Clicked an element] » fonctionne désormais sans redirection ni erreur.** a résolu un problème dans la nouvelle interface utilisateur de création qui entraînait des redirections inattendues et des écrans vides lors de la sélection de la mesure de conversion « [!UICONTROL Clicked an element] ». Cliquer sur un bouton pendant la configuration a déclenché la navigation au lieu d&#39;enregistrer l&#39;élément, ce qui a entraîné une erreur « [!UICONTROL element not found] ». (TGT-53817)
* **Les activités existantes ne sont plus bloquées dans une boucle de chargement infinie lors de la modification.** Correction d’un problème dans la nouvelle interface utilisateur de création où la modification d’une activité existante dans le VEC bloquait la page dans une boucle de chargement infinie. Ce problème n’a pas affecté les activités nouvellement créées et a été déclenché par des modifications préexistantes sur la page. (TGT-53913)
* **Les pages d&#39;activité existantes avec des modifications se chargent désormais correctement dans le VEC.** Correction d’un problème dans la VEC mise à jour qui provoquait le blocage des pages dans la phase de chargement lors de la modification d’une activité existante avec des modifications enregistrées. Les nouvelles activités chargées sans problème, mais les activités précédemment configurées n’ont pas pu être affichées. (TGT-53967)
...
* **La section [!UICONTROL Targeting] n&#39;a pas indiqué qu&#39;une règle d&#39;audience a été définie pour exclure.Les audiences** configurées avec la logique d&#39;exclusion étaient affichées de manière incorrecte en tant qu&#39;inclusion dans la section [!UICONTROL Targeting] de l&#39;interface utilisateur de création d&#39;activité. Bien que le serveur principal ait correctement appliqué la règle d&#39;exclusion, l&#39;interface utilisateur n&#39;a pas pu la représenter visuellement, omettant le libellé « Exclure » et provoquant une confusion lors de la configuration de la campagne. La section [!UICONTROL Targeting] affiche désormais clairement les règles d&#39;exclusion, garantissant ainsi la cohérence entre la configuration de l&#39;audience et la visualisation du ciblage. (TGT-53809)
...
* **Les critères n’ont pas pu être modifiés dans une activité.** Les options [!UICONTROL Edit Criteria] et [!UICONTROL Remove Criteria] ont été désactivées lors de l&#39;accès aux critères à partir d&#39;une activité. Cependant, les mêmes critères ont pu être modifiés avec succès via l&#39;onglet [!UICONTROL Recommendations]. Les critères sont désormais entièrement modifiables à partir du workflow de modification d’activité et de l’onglet [!UICONTROL Recommendations], garantissant ainsi une expérience de modification cohérente et efficace. (TGT-53814)

+++

+++[!UICONTROL Reports]

* **La génération d&#39;offres ad hoc dans les activités A[!UICONTROL utomated Personalization] a provoqué des incohérences de rapport.** L’utilisation de la fonctionnalité Générer des offres ad hoc dans les activités [!UICONTROL Automated Personalization] (AP) entraînait des rapports inexacts. Plus précisément, les identifiants d’offre ont été réutilisés entre les emplacements, ce qui a entraîné l’attribution incorrecte ou le remplacement des données de rapport. Les offres ad hoc sont désormais générées avec des identifiants distincts par emplacement, ce qui garantit un suivi et un reporting précis sur toutes les expériences configurées. (TGT-53757)
...
* **Option permettant de supprimer la collection sélectionnée restaurée dans le compositeur d’expérience visuelle.** Correction d’un problème dans le VEC en raison duquel les utilisateurs ne pouvaient remplacer qu’une collection sélectionnée dans une activité [!UICONTROL Recommendations], mais ne pouvaient pas la supprimer entièrement. Cette limitation a bloqué les cas d’utilisation nécessitant une suppression propre de la collection sans substitution. Ce correctif introduit une option claire pour supprimer la collection sélectionnée, ce qui permet une plus grande flexibilité dans la configuration de l’activité et l’alignement avec le comportement de l’interface utilisateur héritée. (TGT-53652)
* Les collections de critères personnalisés **s&#39;affichent désormais correctement dans l&#39;interface utilisateur [!UICONTROL Recommendations].** Correction d’un problème dans l’interface de Recommendations en raison duquel les collections créées à l’aide de critères personnalisés n’affichaient pas les résultats du produit. Alors que les collections standard basées sur les attributs fonctionnaient comme prévu, celles utilisant des filtres personnalisés ont renvoyé « Aucun résultat trouvé » malgré des correspondances de catalogue valides. Ce correctif garantit que les collections utilisant des attributs personnalisés sont désormais renseignées correctement dans l&#39;onglet [!UICONTROL Product], restaurant ainsi l&#39;intégralité des fonctionnalités pour les workflows de recommandations personnalisées. (TGT-53653)
...
* **Correction d’un problème en raison duquel les critères et les conceptions n’étaient pas affichés sur une ligne dans l’interface utilisateur de création d’activité.** Auparavant, les critères et les conceptions du processus de création d&#39;activité étaient affichés dans un format compressé, ce qui rendait difficile pour les clients d&#39;afficher et de gérer des éléments individuels. Chaque critère et chaque conception apparaissent désormais sur leur propre ligne, ce qui améliore la lisibilité et la convivialité dans l’interface utilisateur mise à jour. (TGT-53818)
...
* La mesure **[!UICONTROL Total Sales]est désormais incluse dans les exportations CSV à partir des rapports d’activité.** a résolu un problème dans l&#39;interface utilisateur mise à jour où la mesure [!UICONTROL Total Sales] apparaissait correctement dans la vue du rapport d&#39;activité mais était manquante dans l&#39;exportation CSV. Cette divergence empêchait les utilisateurs d&#39;accéder à des données de performances complètes dans les rapports téléchargés. Ce correctif garantit que les valeurs [!UICONTROL Total Sales] sont désormais correctement incluses dans les exportations CSV, ce qui restaure la cohérence entre les rapports dans l’application et l’analyse hors ligne. (TGT-53330)
* **Amélioration des messages d&#39;erreur pour [!UICONTROL Graph View] lorsque les mesures ne sont pas activées.** Correction d&#39;un problème dans le VEC en raison duquel [!UICONTROL Graph View] affichait un message générique « Une erreur s&#39;est produite » lorsqu&#39;une mesure demandée n&#39;était pas activée dans la suite de rapports [!DNL Analytics] associée. Ce problème a été déclenché par une erreur `not_enabled_metric` dans la réponse GraphQL du serveur principal. Ce correctif remplace l’erreur vague par un message plus informatif qui aide les utilisateurs et utilisatrices à identifier les problèmes de configuration dans [!DNL Analytics], ce qui réduit la confusion et les remontées inutiles de l’assistance. (TGT-53577)
...
+++Voir les détails
* **Les métadonnées d’élément sont désormais visibles au survol du menu de navigation.** Amélioration du menu de navigation dans le VEC pour afficher des détails supplémentaires sur les éléments tels que l&#39;ID, la classe et le nom lors du survol d&#39;un élément. Cette amélioration permet aux utilisateurs d’identifier et de différencier plus facilement les éléments lors de la configuration des activités. (TGT-53409)
* **Le survol du chemin de navigation met désormais en surbrillance l’élément correspondant dans le VEC.** Amélioration de [!UICONTROL Visual Experience Composer] pour mettre en surbrillance l&#39;élément correspondant dans l&#39;éditeur lorsque vous survolez des éléments dans le menu de navigation. Le type d’élément est également affiché, par exemple conteneur, texte en gras ou bouton. Ce comportement s’applique aux éléments frères et exclut les types non pris en charge tels que SVG, en fonction de la liste de validation. (TGT-53411)
...
* **Correction d’un problème en raison duquel le VEC se bloquait et affichait un écran vide lors du chargement de certaines activités.** clients d&#39;un client spécifique ont signalé que l&#39;éditeur n&#39;a pas pu charger des activités spécifiques. Le VEC est resté bloqué sur « Application des modifications initiales » avant de se bloquer et d’afficher un écran vide. Le VEC charge désormais les activités affectées sans erreurs dans le processus de création d’activité mis à jour. (TGT-52932)
* **Correction d’un problème en raison duquel le rail [!UICONTROL Manage Content] dans les activités [!UICONTROL Automated Personalization] affichait des étiquettes d’emplacement incohérentes.Les clients** ont signalé que le rail [!UICONTROL Manage Content] affichait des numéros d&#39;emplacement incompatibles dans les onglets [!UICONTROL Experiences] et [!UICONTROL Offers]. (par exemple, Emplacement 2 et Emplacement 4 dans Expériences, et Emplacement 1 et Emplacement 2 dans Offre) même lorsque seulement deux emplacements ont été configurés. Les libellés d’emplacement sont désormais cohérents et mappés avec précision aux modifications, ce qui améliore la clarté et la convivialité du processus de création d’activités. (TGT-52934)
...
* **Sélection d&#39;élément améliorée dans la CVE en affichant le type d&#39;élément au survol et lors de la sélection.** Pour améliorer la convivialité lors de la création d&#39;activités, le VEC décore désormais les éléments de HTML avec leur type lorsqu&#39;ils sont survolés ou sélectionnés. Cette amélioration permet aux clients d’identifier et de sélectionner plus facilement les éléments corrects. Les éléments sélectionnés sont mis en surbrillance avec une couleur distincte et les éléments survolés sont entourés en bleu. Le type d’élément s’affiche également, fournissant un contexte plus clair lors de la modification. (TGT-53502)

+++

### Mises à jour des flux de données (19 septembre 2025)

La combinaison ID de flux de données et sandbox doit être unique pour les connexions de destination [!DNL Adobe Target].

Mise à jour de la logique de validation pour les connexions de destination [!DNL Target] afin d&#39;imposer que la combinaison de l&#39;ID du flux de données et du nom du sandbox doit être unique dans une organisation IMS. Cela signifie :
...
Cette version contient les mises à jour et correctifs suivants :

**[!UICONTROL Activities]**

+++Voir les détails
* **Les clients ne pouvaient pas copier les noms d&#39;activité ou de document à partir de[!UICONTROL Activity Overview]** : auparavant, les clients ne pouvaient pas copier le nom d&#39;une activité ou l&#39;offre/document associé directement à partir de [!UICONTROL Activity overview] dans le processus de création d&#39;activité mis à jour. Cette limitation a eu un impact sur la convivialité, en particulier sur les petits écrans. Les clients peuvent désormais copier facilement les noms d’activité et de document sans solutions. (TGT-51850)
...
* **Correction d’un problème qui provoquait un filtrage sensible à la casse dans [!UICONTROL Product Catalog Search] recherche avancée** : le filtrage de recherche avancé dans la page [!UICONTROL Product Catalog Search] ignore désormais correctement le respect de la casse, en s’alignant sur le comportement du serveur principal et des services GraphQL. Cette mise à jour garantit des résultats de suggestion cohérents et précis pour les clients, quelle que soit la casse du texte. (TGT-53585)
* **La recherche avancée dans l&#39;interface utilisateur [!UICONTROL Product Catalog Search] mise à jour n&#39;a pas fourni de suggestions** : les clients utilisant la fonctionnalité de recherche avancée dans l&#39;interface utilisateur [!UICONTROL Product Catalog Search] mise à jour devaient saisir des valeurs exactes avec l&#39;orthographe correcte, car aucune suggestion n&#39;était affichée. Ce problème rendait difficile la localisation efficace des produits. Les suggestions s’affichent désormais comme prévu lors de la saisie de la recherche avancée. (TGT-52008)
...
* Les **activités en direct pouvaient toujours être modifiées dans le VEC** : les clients pouvaient accéder aux options de modification des activités en direct dans le VEC mis à jour, ce qui pouvait entraîner des modifications involontaires. Ce problème a été résolu en désactivant la fonctionnalité de modification pour les activités en direct. Les boutons Modifier sont désormais masqués dans la liste d’activités et la vue d’ensemble pour les éditeurs, tandis que les approbateurs et les autres rôles ne sont pas affectés. (TGT-53055)
* **Mise hors service de la section [!UICONTROL Failed] et [!UICONTROL Draft] activités dans le VEC mis à jour** : les options [!UICONTROL Failed] et [!UICONTROL Draft] activités ont été supprimées du VEC mis à jour. La nouvelle interface utilisateur ne prend plus en charge les états de brouillon. Les campagnes en échec ne sont pas stockées dans le serveur principal. Ces options ne sont plus pertinentes. Les filtres associés et les champs du serveur principal (par exemple, `uiSyncFailed`, `errorMessage`) ont également été supprimés afin de rationaliser la gestion des activités. (TGT-53150)
...
* **Lorsque vous appuyez deux fois sur le bouton Précédent en mode [!UICONTROL Browse], le VEC s’est bloqué** : les clients et clientes qui naviguaient en mode [!UICONTROL Browse] dans le VEC ont rencontré des blocages lorsqu’ils ont appuyé deux fois sur le bouton Précédent du navigateur. Ce problème a entraîné le blocage de l’éditeur et a nécessité une actualisation de la page. L’éditeur gère désormais la navigation arrière de manière fiable sans blocage. (GT-53568)
...
* **Correction d’un chargement d’image incohérent dans[!UICONTROL Catalog Search]** : correction d’un problème en raison duquel les vignettes et les images dans [!UICONTROL &#x200B; Catalog Search] ne se chargeaient pas de manière cohérente dans le processus de création d’activité. Les images ne s’affichaient pas, sauf si la colonne « URL de la vignette » était visible et que certaines images de produit étaient chargées partiellement ou pas du tout après les actions de navigation ou de recherche. Le comportement de chargement des images a été stabilisé et les vignettes s’affichent désormais de manière fiable, indépendamment de la visibilité des colonnes ou des actions de navigation. (TGT-52778)
* **Correction d’un problème en raison duquel la modification d’une recommandation dans une expérience dupliquée affectait l’expérience d’origine** : les clients ont signalé que la modification d’une recommandation dans une expérience dupliquée modifiait involontairement l’expérience d’origine. Plus précisément, après la duplication de l’expérience B dans le processus de création d’activité et la modification de sa conception ou de ses critères, les mêmes modifications ont été reflétées dans l’expérience B d’origine, bien qu’il s’agisse d’entités distinctes. Les expériences dupliquées conservent désormais des configurations distinctes, ce qui garantit que les modifications apportées à une expérience n’affectent pas l’expérience originale. (TGT-53369)
...
+++Afficher les détails
* **Correction d’un problème dans le processus de création d’activités qui bloquait la progression vers l’étape [!UICONTROL Targeting] dans les activités AP**: correction d’un problème dans le processus de création d’activités en raison duquel les clients ne pouvaient pas passer à l’étape [!UICONTROL Targeting] dans les activités [!UICONTROL Automated Personalization] (AP) à moins que deux emplacements ne soient ajoutés. Ce comportement différait de l&#39;expérience précédente, où un seul emplacement avec plusieurs offres était suffisant. L’exigence a été corrigée, permettant aux clients de continuer à utiliser des configurations à emplacement unique dans le cadre de leurs workflows d’API. (TGT-53426)
* **Correction d’un problème en raison duquel le nouveau processus de création d’activité ne définissait pas le paramètre fmt=png-alpha pour les images transparentes** : dans l’interface utilisateur mise à jour, les images insérées pendant le processus de création d’activité n’incluaient plus le paramètre `fmt=png-alpha` par défaut, ce qui entraînait une perte de transparence. Ce comportement différait de l’interface utilisateur précédente, qui ajoutait automatiquement le paramètre aux URL des images, préservant ainsi les arrière-plans transparents. Le processus de création d&#39;activité applique désormais correctement le paramètre `fmt=png-alpha` aux URL d&#39;image lorsque la transparence est requise, garantissant ainsi un rendu cohérent des actifs transparents. (TGT-52615)
* **Correction d’un problème qui empêchait les clients de rechercher des suites de rapports dans l’interface utilisateur mise à jour** : dans l’interface utilisateur mise à jour, la liste déroulante [!UICONTROL Report Suites] de la section [!UICONTROL Goals & Settings] ne permettait pas aux clients de saisir et de rechercher des suites de rapports spécifiques, ce qui rendait difficile la localisation de suites de rapports spécifiques, en particulier pour les clients ayant un grand nombre d’entrées. Contrairement à l’interface utilisateur précédente, la liste n’était pas triée et ne comportait pas de filtrage basé sur les entrées. Ce problème a été résolu. Les clients peuvent désormais saisir du texte pour rechercher et filtrer des suites de rapports, restaurant ainsi la fonctionnalité disponible dans l’interface utilisateur héritée. (TGT-53514)
...
+++Voir les détails
* **Correction d’un problème en raison duquel un client restreint à un seul espace de travail pouvait afficher des activités à partir d’autres espaces de travail** : les clients dont l’accès était limité à un espace de travail pouvaient de manière inattendue afficher des activités dans tous les espaces de travail lors de la sélection de [!UICONTROL All Workspaces] dans le processus de création d’activités. Cette visibilité risquait de modifier involontairement les activités en direct dans d’autres espaces de travail, ce qui pouvait avoir un impact sur les performances du site Web. Les contrôles d’accès à l’espace de travail ont été renforcés pour garantir que les clients peuvent consulter et interagir uniquement avec les activités de l’espace de travail qui leur est attribué. (TGT-53101)
...
* **Problème de besoin d’expérience résolu dans le processus de création d’activités pour les activités AP dans l’interface utilisateur mise à jour** : correction d’un problème dans le processus de création d’activités où les activités [!UICONTROL Automated Personalization] (AP) nécessitaient deux emplacements au lieu de deux expériences dans l’interface utilisateur mise à jour. Ce comportement a bloqué les cas d’utilisation où les clients configuraient un emplacement unique avec plusieurs offres, qui était précédemment pris en charge. L&#39;exigence a été corrigée pour correspondre à la fonctionnalité d&#39;origine, ce qui permet aux clients de poursuivre les activités AP en utilisant deux expériences quel que soit le nombre d&#39;emplacements. (TGT-53429)
...
+++Voir les détails
* **Problème résolu dans le processus de création d’activité qui autorisait la modification involontaire du HTML des fragments exportés par AEM** : correction d’un problème dans le processus de création d’activité qui permettait aux clients de modifier le HTML de [!DNL Experience Fragments] (XF) exporté à partir de [!DNL Adobe Experience Manager] (AEM) dans [!DNL Target]. Ce comportement était involontaire, car les fichiers XF devaient rester verrouillés pour modification une fois publiés à partir d’AEM. Le correctif garantit que l’option « Modifier le HTML » n’est plus disponible pour les fragments exportés par AEM, ce qui préserve l’intégrité du contenu et la gouvernance attendue. (TGT-53286)
* **Correction d’un problème d’aperçu intermittent du contenu XF dans le processus de création d’activité dans l’interface utilisateur mise à jour** : correction d’un problème dans le processus de création d’activité en raison duquel le contenu XF ne pouvait pas être affiché par intermittence en mode d’aperçu dans l’interface utilisateur mise à jour. Bien que le contenu ait été correctement diffusé, l’aperçu ne s’affichait pas de manière cohérente, ce qui rendait difficile la validation de la configuration de l’offre par les clients. Les aperçus XF se chargent désormais de manière fiable, ce qui améliore la confiance et l’efficacité pendant la configuration des activités. (TGT-53318)
...
+++Voir les détails
* **Problème résolu dans le processus de création d’activité où les espaces d’interlignage dans les URL provoquaient des liens d’assurance qualité rompus** : correction d’un problème dans le processus de création d’activité où les espaces d’interlignage dans l’URL d’activité n’étaient pas rognés correctement lors de l’enregistrement. Cela entraînait des liens d’assurance qualité non valides et un formatage incorrect dans le serveur principal. Après la mise à jour, les URL sont désormais enregistrées proprement, ce qui empêche les liens rompus et améliore la fiabilité des workflows d’assurance qualité pour les clients et les clientes. (TGT-53427)
...
* **Résolu plusieurs problèmes d&#39;interface utilisateur et de filtrage pour améliorer la réactivité et l&#39;interaction des entités** : résolution de plusieurs problèmes, notamment la faible réactivité des détails des critères sur les appareils à petit écran, l&#39;absence de résultats lors de la sélection de « Tous les groupes hôtes » dans le filtre Environnement et l&#39;incapacité à interagir avec des entités sans nom. Ces correctifs améliorent la convivialité quelle que soit la taille de l’écran, garantissent un filtrage précis et permettent une interaction complète avec toutes les entités du produit, améliorant ainsi l’expérience globale des utilisateurs. (TGT-52992)
* **Correction des ID de produit manquants dans la vue détaillée de Recommendations lors de la création d’activités** : correction d’un problème dans le processus de création d’activités [!DNL Recommendations] en raison duquel les ID de produit étaient manquants dans l’écran de détails du produit, ce qui rendait difficile pour les clients de copier ou de référencer les ID de produit pendant les workflows. Les ID de produit apparaissent désormais clairement dans la vue détaillée, ce qui améliore la visibilité et permet une gestion plus efficace des produits pour les clients. (TGT-51964)
...
+++Afficher les détails
* **Problèmes de chargement d’activité et de bouton [!UICONTROL Cancel] résolus dans le processus de création d’activité** : correction d’un problème dans le processus de création d’activité en raison duquel certaines activités ne se chargeaient pas, empêchant les clients d’accéder aux modifications. En outre, le bouton [!UICONTROL Cancel] ne répondait pas, empêchant les clients d&#39;arrêter le processus de chargement ou de quitter la vue de modification. Ce correctif garantit que les activités se chargent désormais de manière fiable et que le bouton [!UICONTROL Cancel] fonctionne comme prévu, améliorant ainsi la stabilité globale et l’expérience utilisateur dans Visual Experience Composer. (VEC)(TGT-53218)
* **Correction d’un problème de changement d’expérience dans l’interface utilisateur VEC mise à jour qui bloquait la modification et désactivait le bouton [!UICONTROL Cancel]** : correction d’un problème dans l’interface utilisateur VEC mise à jour en raison duquel les modifications ne se chargeaient pas lors du changement d’expérience dans une activité de ciblage d’expérience (XT). Les clients ne pouvaient pas modifier les expériences au-delà de celle qu&#39;ils avaient initialement saisie, et le bouton [!UICONTROL Cancel] était manquant ou ne répondait pas. Ce correctif garantit que les modifications se chargent désormais correctement dans toutes les expériences et que le bouton [!UICONTROL Cancel] fonctionne de manière fiable, même sans l&#39;extension Helper, améliorant les workflows de modification et réduisant la frustration. (TGT-53256)
* **Correction d’un problème d’écran blanc lors du basculement entre plusieurs expériences dans le processus de création d’activité** : correction d’un problème en raison duquel le basculement entre plusieurs expériences entraînait un écran blanc. Correction également d’un problème dans le processus de création d’activités en raison duquel les clients et clientes rencontraient un écran blanc lorsqu’ils tentaient de modifier plusieurs expériences au sein d’une activité. Ce problème se produisait après l’application des modifications à deux expériences, puis la sélection d’une troisième expérience, ce qui empêchait d’autres modifications. La mise à jour assure des transitions fluides entre les expériences, ce qui permet aux clients d’apporter des modifications sans interruption. (TGT-53266)
...
+++Afficher les détails
* Correction d’un problème en raison duquel la modification d’une offre de HTML existante via Visual Experience Composer (VEC) entraînait la suppression de toutes les modifications de la livraison de contenu. Les modifications apparaissent grisées dans l’onglet de modification et ne sont pas reflétées dans les aperçus d’assurance qualité, bien qu’elles aient été correctement appliquées dans l’interface utilisateur héritée. (TGT-52863)
* Correction d’un problème dans l’interface utilisateur [!DNL Target] mise à jour en raison duquel les modifications de l’offre de HTML effectuées dans [!UICONTROL Visual Experience Composer] (VEC) ne persistaient pas après la navigation de l’onglet [!UICONTROL Targeting] vers [!UICONTROL Experiences]. (TGT-52874)
...
+++Afficher les détails
* Correction d’un problème dans le VEC mis à jour qui empêchait les clients et clientes d’appliquer des modifications aux vues [!UICONTROL Single Page Application] (SPA). Alors que les activités créées dans l’ancienne interface utilisateur prenaient en charge le ciblage spécifique aux vues, la nouvelle interface utilisateur ne pouvait pas détecter ou autoriser les modifications de ces vues, les commandes de changement de vue apparaissant désactivées. (TGT-52556)
...
* Correction d’un problème en raison duquel les clients ne pouvaient pas copier les activités entre les espaces de travail en raison d’une défaillance de la mutation `copyActivityBatchOperations`. Les tentatives de duplication d’activités ont entraîné une erreur de serveur (500) et une charge utile de réponse nulle. (TGT-52405)
* Correction d’un problème en raison duquel les activités ne se synchronisaient pas lorsque les offres référencées dans la configuration n’étaient pas accessibles dans l’espace de travail sélectionné. Cela a provoqué des erreurs de publication et a laissé les activités en échec. (TGT-52535)
...
+++Voir les détails
* Correction d’un problème en raison duquel l’environnement d’assurance qualité ne parvenait pas à charger les données sur plusieurs onglets, rendant l’interface inutilisable. (TGT-53377)
* Correction d’un problème qui empêchait la création d’une activité dans l’environnement d’assurance qualité. Le processus a été redirigé vers la page [!UICONTROL Activities] au lieu de s&#39;être terminé correctement. (TGT-53328)
...
* Correction d’un problème en raison duquel la fonctionnalité [!UICONTROL Redirect to URL] ne fonctionnait pas comme prévu : aucune redirection ne se produisait même avec des URL valides. (TGT-53307)
...
+++Afficher les détails
* Correction d’un problème en raison duquel la copie d’activités entre les espaces de travail entraînait des entrées « Audience Copy » en double et des conflits d’ID. Les audiences sont désormais copiées avec des ID uniques, un contexte d’espace de travail et un traitement récursif pour les audiences combinées (jusqu’à 5 niveaux). (TGT-53081)
* Correction d’un problème en raison duquel l’espace de travail était défini sur « [!UICONTROL All Workspaces] ». La copie d’une activité qui existe déjà dans l’espace de travail par défaut entraîne une erreur incorrecte :

  « Au moins une propriété doit être incluse pour les espaces de travail autres que ceux par défaut. »

  Dans la mesure où la copie se trouve dans l’espace de travail par défaut, aucune propriété ne doit être requise. La tentative d’ajout d’une propriété et d’enregistrement entraîne une deuxième erreur :
...
En raison de problèmes récents identifiés, principalement liés à des personnalisations complexes des clients, cette version inclut les correctifs et mises à jour suivants :
...
+++Voir les détails
* Correction d’un problème qui empêchait [!UICONTROL Catalog Search] de charger des résultats supplémentaires lors du défilement vers le bas de la liste, restaurant le comportement cohérent avec l’interface utilisateur héritée. (TGT-53088)
...
* Nouvelle implémentation de la couche de persistance des options supprimées dans le serveur principal de Target pour prendre en charge la création de rapports historiques précis dans les activités [!UICONTROL Automated Personalization] (AP). Auparavant, lorsqu’une option était supprimée, son nom était perdu, ce qui rendait difficile l’interprétation des données de performances antérieures.
  ...
  **Améliorations clés** :
   ...
   * Les options supprimées sont désormais suivies à l&#39;aide de l&#39;infrastructure `RemovedCampaignElements` et `RemovedOptionInfo` existante.
   * Lorsqu&#39;une option est supprimée d&#39;une activité AP, ses métadonnées (par exemple, ID et nom) sont conservées.
...
* Correction d’un problème lors de la copie d’une activité d’un espace de travail non par défaut vers un espace de travail par défaut ou entre des espaces de travail non par défaut. Les offres sont désormais dupliquées avec un suivi et un nommage améliorés afin d’éviter les conflits.
  ...
  **Améliorations clés** :
   ...
   * Cette fonctionnalité permet d’éviter les erreurs causées par plusieurs noms « Copie de l’offre » identiques lors d’actions de copie répétées.
   * Les offres peuvent ne pas apparaître immédiatement dans la liste d&#39;offres de l&#39;espace de travail de destination, mais sont traitées et affichées de manière appropriée.
...
+++Voir les détails
* Ajout d’un avertissement de confirmation supplémentaire lors de l’annulation des modifications d’activité non enregistrées : « Voulez-vous vraiment enregistrer cette activité ? Si vous n’enregistrez pas, toutes vos modifications seront perdues. » Ce message permet d’éviter toute perte de données accidentelle. (TGT-52865)
* Restauration de la fonctionnalité héritée vers le curseur [!UICONTROL Priority] dans [!UICONTROL Goals & Settings], permettant aux clients de saisir une valeur numérique directement, comme pris en charge dans l&#39;interface utilisateur héritée. (TGT-53185 et TGT-53219)
...
+++Voir les détails
* Correction d’un problème en raison duquel les clients consultaient les rapports d’activités spécifiques sur la page [!UICONTROL Goals & Settings]. Le lien [!UICONTROL View in Analytics] pointait de manière incorrecte vers l’environnement d’assurance qualité au lieu de l’environnement de production. (TGT-53163)
...
* Correction d’un problème en raison duquel les [recommandations en tant qu’offres](/help/main/c-recommendations/recommendations-as-an-offer.md) dans les activités [!UICONTROL A/B Test] n’étaient pas mises à jour correctement lors de la modification des collections ou des promotions. (TGT-52884)
* Correction d’un problème dans l’environnement de production en raison duquel le fait de cliquer sur une entité dans l’interface utilisateur mise à jour affichait l’erreur : « Échec de récupération des détails du produit. Si le problème persiste, contactez [!DNL Adobe Client Care]. » (TGT-53071)
...
* Correction d’un problème en raison duquel les améliorations de l’audience uniquement liées à l’activité disparaissaient de l’interface utilisateur immédiatement après avoir été supprimées d’un emplacement, avant même l’enregistrement de l’activité. Ce comportement était en contradiction avec la fonctionnalité attendue et les instructions de l’info-bulle, qui indiquent : « Tous les publics inutilisés de cette bibliothèque seront supprimés une fois l’activité enregistrée. » (TGT-52982)
* Correction d’un problème lors de la tentative d’affectation d’une audience autre que [!UICONTROL All Visitors] à une activité. Lors de l’enregistrement, le message d’erreur suivant s’affiche : « Impossible d’effectuer cette opération. Veuillez contacter [!UICONTROL Adobe Client Care] si le problème persiste. » (TGT-53008)
...
* Correction d’un problème en raison duquel le fait de cliquer sur le lien « [!UICONTROL View in Analytics] » redirigeait les utilisateurs vers la page d’accueil au lieu du tableau de bord [!DNL Analytics] prévu. (TGT-53092 et TGT-53093)
...
* Correction d’un problème affectant le workflow de création d’activités lors de l’ajout de [!DNL Recommendations] avec [!UICONTROL promotions]. Lorsque les utilisateurs sélectionnaient « [!UICONTROL Promote by Attribute] » et ajoutaient une règle de filtrage (par exemple, [!UICONTROL Parameter Matching]), le type de règle et les valeurs d&#39;opérande sélectionnés n&#39;étaient pas conservés après l&#39;enregistrement et la modification de l&#39;activité. Lors de la réouverture, le type de règle de filtrage changerait de manière inattendue et les valeurs d&#39;opérande seraient manquantes. (TGT-53059)
* Correction d&#39;un problème dans l&#39;interface utilisateur [!DNL Recommendations] en raison duquel une promotion créée avec une seule règle était mal interprétée et affichée en tant que type de promotion « Liste d&#39;éléments », quelle que soit la logique de la règle. (TGT-53063)
* Correction d’un problème lors de l’utilisation de l’[!UICONTROL Overview]interface utilisateur mise à jour, le bouton « [!UICONTROL Download Recommendations Data] » était manquant pour les activités [!UICONTROL Experience Targeting] (XT) qui incluent [!DNL Recommendations]. (TGT-52730 et TGT-52756)
...
* Correction d’un problème en raison duquel les modifications du code personnalisé s’affichaient incorrectement pour une expérience incorrecte. Plus précisément, les changements destinés à une expérience ont été montrés dans une expérience différente, conduisant à la confusion et à une mauvaise configuration potentielle des activités en direct. (TGT-52776)
* Correction d’un problème qui empêchait la modification ou l’enregistrement des modifications de code personnalisées dans la nouvelle interface utilisateur VEC. Plus précisément :
...
* Correction d’un problème en raison duquel la modification et l’enregistrement du code personnalisé empêchaient le panneau [!UICONTROL Modifications] de répondre. (TGT-53075)
* Correction d’un problème en raison duquel les modifications apportées au code personnalisé dans des expériences de variantes étaient involontairement reflétées dans l’expérience [!UICONTROL Control]. Cela a provoqué des changements involontaires dans le comportement de livraison. L&#39;expérience [!UICONTROL Control] reste désormais isolée des modifications de code personnalisées apportées à d&#39;autres expériences. (TGT-52413)
* Correction d’un problème en raison duquel les modifications apportées à une expérience (par exemple, l’expérience B) étaient involontairement dupliquées vers une autre expérience (expérience A) si l’utilisateur cliquait sur la deuxième expérience avant que l’éditeur ne soit entièrement chargé. Ce comportement peut également entraîner la perte des modifications si l’expérience sélectionnée initialement n’a pas été modifiée. (TGT-52597)
...
* Correction de plusieurs problèmes dans le workflow de création d’activités liés à la dénomination des offres et à la traduction du contenu dans les activités [!UICONTROL Automated Personalization] (AP) et [!UICONTROL Multivariate Testing] (MVT) :
   ...
   * La création de plusieurs offres de HTML portant le même nom (par exemple, « Expérience ») a déclenché une erreur « Les noms d’offres en double ne sont pas autorisés », mais l’interface utilisateur n’a pas indiqué clairement quelles offres étaient à l’origine du conflit.
   * Renommer les offres via le panneau de droite a mis à jour le nom dans l’interface utilisateur, mais la modification n’a pas été reflétée dans l’onglet [!UICONTROL Manage Content] ou [!UICONTROL Offers], ce qui entraîne des erreurs de validation persistantes.
   * Dans les activités MVT, bien que l’erreur de nom en double ne persiste pas après le changement de nom, l’interface utilisateur ne reflète toujours pas les noms d’offre mis à jour de manière cohérente dans les différents onglets. (TGT-52933)
...
* Correction d’un problème lors de l’application de modifications dans la CVE mise à jour. Les modifications s’affichent initialement correctement, y compris le [!UICONTROL Experience Fragment] attendu. Cependant, lors du changement d’expérience ou de modifications supplémentaires, certaines modifications ne s’appliquent pas en raison de problèmes de sélecteur. (TGT-52679)
* Correction d’un problème en raison duquel, lorsqu’une nouvelle activité était créée par clonage d’une activité existante, les liens d’assurance qualité dans l’activité clonée conservaient de manière incorrecte les URL de page de l’activité d’origine. (TGT-52775)
...
* Correction d&#39;un problème qui empêchait la modification d&#39;une activité de produit [!DNL Recommendations]. Lors de la tentative d’accès au VEC via l’interface utilisateur de Target, une erreur s’est produite sur la page [!UICONTROL Overview], empêchant toute modification. (TGT-52823)
...
* Correction d’un problème en raison duquel les utilisateurs avec le rôle [!UICONTROL Editor] ne pouvaient pas modifier une activité [!DNL Recommendations]. Toute tentative de modification de la conception et d’enregistrement de l’activité a provoqué une erreur 403 Interdit, indiquant que le privilège « [editor] » était requis, même si l’utilisateur jouait déjà ce rôle dans l’espace de travail approprié. (TGT-52836)

### [!DNL Target Standard/Premium] 25.6.3 (samedi 20 juin 2025)

Cette version inclut les correctifs et mises à jour suivants :

* Correction d’un problème en raison duquel la copie d’une activité d’un espace de travail vers un autre espace de travail déclenchait des erreurs telles que « ne doit pas être null » ou « Une erreur s’est produite ». (TGT-52474)
...
* Correction d&#39;une erreur qui se produisait lors de la mise à jour d&#39;une activité [!UICONTROL Recommendations] en direct en raison d&#39;une propriété non reconnue dans la payload de la demande. Le système gère désormais correctement le fichier « JSON non valide ». Erreur « Nom de propriété non reconnu ». (TGT-52723)
...
* Correction d&#39;une erreur où, après la migration vers AP V2, certains appels API vers `/admin/rest/ui/v1/campaigns` renvoyaient des erreurs côté client (HTTP 4xx). (TGT-52721)

### [!DNL Target Standard/Premium] 25.6.2 (vendredi 12 juin 2025)

Cette version inclut les correctifs et mises à jour suivants :

* Ajout d&#39;un [nouvel article de FAQ](/help/main/c-intro/updated-ui-faq.md) pour répondre aux questions courantes sur l&#39;interface utilisateur [!DNL Target] mise à jour et [!UICONTROL Visual Experience Composer] (VEC).
* Correction d&#39;un problème en raison duquel la règle « [!UICONTROL URL - does not contain] » dans [!UICONTROL Page Delivery] ne fonctionnait pas, permettant ainsi l&#39;affichage du contenu même lorsqu&#39;il aurait dû être bloqué. (TGT-52754)
...
* Correction d’un problème en raison duquel le modal « Modifier l’audience » apparaissait vide lors de la modification du ciblage d’audience dans le [!UICONTROL Visual Experience Composer] (VEC) mis à jour. (TGT-52749)
* Ajout d’un message pour informer les utilisateurs lorsqu’une entité n’est pas accessible dans l’espace de travail sélectionné. (TGT-52767)
...
* Correction d’un problème en raison duquel les liens d’assurance qualité ne fournissaient pas l’expérience correcte pour l’activité associée. (TGT-52163 et TGT-52790)
...
* Correction d’un problème dans le VEC mis à jour en raison duquel le passage du mode [!UICONTROL Browse] au mode [!UICONTROL Design] entraînait une erreur de console et empêchait toute interaction ultérieure. (TGT-52532)
...
* Correction d’un problème en raison duquel l’activité basée sur le formulaire générait des liens QA incorrects. L&#39;URL d&#39;activité incluait un `http://pid-ppc` involontaire au début de l&#39;URL, qui a été supprimée pour garantir l&#39;exactitude de la liaison. (TGT-52557)
* Correction d’un problème en raison duquel [!DNL Target] générait des liens QA non valides pour les activités basées sur les formulaires. (TGT-52528 et TGT-52603)
...
* Correction d&#39;un problème en raison duquel la fonction de recherche par nom dans la liste [!UICONTROL Activities] ne fonctionnait pas correctement avec les requêtes multimots. (TGT-52529)
...
[!DNL AI Assistant] dans [!UICONTROL Target] est un outil de conversation que vous pouvez utiliser pour accélérer vos workflows avec des applications et des services [!DNL Experience Platform]. Utilisez [!DNL AI Assistant] pour augmenter votre productivité globale et améliorer votre compréhension des connaissances sur les produits

Dans [!DNL Target], la première phase de [!DNL AI Assistant] fournit des connaissances inestimables sur le produit, fondées sur la documentation [!DNL Experience League]. Que vous configuriez un script de profil, résolviez des erreurs ou envisagiez une mise à niveau vers le SDK Web AEP, [!DNL AI Assistant] est là pour vous.

Pour plus d&#39;informations, voir [Présentation de l&#39;assistant Adobe Experience Platform AI](/help/main/c-intro/ai-assistant.md).

### [!DNL Target Standard/Premium] 25.5.2 (8 mai 2025)

Cette version comprend les correctifs et mises à jour suivants :

* [!DNL Target] utilisateurs disposant de droits [!UICONTROL Product Administrator] et [!UICONTROL System Administrator] peuvent désormais modifier tous les paramètres des pages [!UICONTROL Administration], quel que soit leur rôle dans [!DNL Target]. Les utilisateurs sans ces autorisations ont un accès en lecture seule à ces paramètres. Cette mise à jour garantit un contrôle d&#39;accès plus strict sur les [paramètres d&#39;administration](/help/main/administrating-target/administrating-target.md). (TGT-48179)
...
* Correction d’un problème qui entraînait l’inversion des améliorations d’audience et des audiences d’activité dans l’interface utilisateur mise à jour. (TGT-52158)
* Correction d’un problème qui empêchait la création d’une nouvelle activité en raison de l’erreur de saisie de l’utilisateur : « espace de travail non par défaut non autorisé pour cet utilisateur ». (TGT-52267)
...
* Correction d’un problème en raison duquel [!DNL Target] n’avertissait pas les clients lors de la modification d’une activité et de la modification d’un élément de site Web modifié. (TGT-52100)
...
* Correction d’un problème qui entraînait une erreur de charge utile non valide lors du déplacement d’offres vers des dossiers. (TGT-52325)
* Correction d’un problème qui entraînait une erreur de saisie de l’utilisateur lors du déplacement des offres vers les dossiers. (TGT-52296)
...
### [!DNL Target Standard/Premium] 25.4.5 (samedi 25 avril 2025)

Cette version comprend les correctifs et mises à jour suivants :

* Correction d’un problème qui entraînait des différences dans les listes d’audience entre la page des paramètres [!UICONTROL Activity] et la page de présentation [!UICONTROL Reporting]. (TGT-52203)
* Correction d’un problème qui empêchait l’ajout d’une nouvelle page à une activité en raison d’une erreur de saisie utilisateur non valide. (TGT-52263)
...
* Correction d’une erreur qui empêchait la modification d’une activité XT en raison d’une règle d’interface utilisateur non prise en charge. (TGT-52273)
* Correction d’un problème dans la mise à jour [!UICONTROL Visual Experience Composer] (VEC) en raison duquel les chemins de navigation n’étaient pas toujours affichés en bas de l’éditeur, ce qui entraînait des difficultés pour sélectionner précisément les éléments. (TGT-52169)
* Correction d’un problème en raison duquel la liste déroulante [!UICONTROL Audience] n’affichait pas tous les publics en raison de la pagination. (TGT-52204)
* Correction d’un problème qui provoquait un message d’entrée utilisateur non valide lors de l’ajout de nouvelles offres dans les activités [!UICONTROL Automated Personalization] (AP). (TGT-52210)
* Correction d’un problème en raison duquel [!UICONTROL Analytics for Target] (A4T) n’était pas correctement sélectionné comme source de rapport, même si le client n’avait pas accès à A4T. (TGT-52226)
* Correction d&#39;un problème qui empêchait l&#39;enregistrement d&#39;une activité avec la mesure d&#39;URL [!UICONTROL View a Page]. (TGT-52260)
...
### Mise à jour des autorisations cibles (22 avril 2025)

Cette future mise à jour améliore le contrôle organisationnel sur les configurations d&#39;instance [!DNL Target], empêchant les mises à jour accidentelles qui pourraient affecter la livraison de l&#39;activité dans diverses équipes de test et de personnalisation.

À compter du 22 avril 2025, seuls [!UICONTROL Product] et [!UICONTROL Solutions] administrateurs pourront mettre à jour les paramètres dans les sections [!UICONTROL Administration], quel que soit leur rôle dans les espaces de travail [!DNL Target]. Les utilisateurs sans cette autorisation auront un accès en lecture seule aux sections [!UICONTROL Administration].

Pour plus d&#39;informations, voir [Administrer la cible](/help/main/administrating-target/start-target.md).

### [!DNL Target Standard/Premium] 25.4.4 (vendredi 17 avril 2025)
...
### [!DNL Target Standard/Premium] 25.4.3 (samedi 11 avril 2025)
...
### [!DNL Target Standard/Premium] 25.4.1 (jeudi 2 avril 2025)
...
* Correction d’un problème qui entraînait un rendu incorrect lors de l’annulation des modifications de style de texte. (TGT-51876)
* Correction d’un problème en raison duquel, lors de la modification d’une offre de redirection, [!DNL Target] supprime également les sélecteurs [!UICONTROL ClickTrack] associés à cette offre. (TGT-51936)
...
* Correction d&#39;un problème en raison duquel l&#39;URL dans [!UICONTROL Visual Experience Composer] ne se mettait pas correctement à jour lors de la navigation par activité. (TGT-51832)
* Correction d’un problème qui empêchait les offres d’apparaître dans l’interface utilisateur [!UICONTROL Offers], bien qu’elles s’affichent correctement lors de la création d’une activité et de l’ajout d’offres. (TGT-51805)
* Correction d’un problème en raison duquel certaines activités ne disposaient pas d’écran de secours pour afficher le contenu par défaut lorsque du contenu personnalisé ou ciblé ne pouvait pas être diffusé. (TGT-51638)
* Correction d’un problème qui empêchait l’affichage correct des offres en direct et de certains dossiers dans l’interface utilisateur [!UICONTROL Offers]. (TGT-51628)
...
* Résolution de l&#39;erreur « Entrée utilisateur non valide » dans les activités [!UICONTROL Visual Experience Composer] (VEC) avec [!UICONTROL Click Tracking] activé lorsque le même sélecteur [!UICONTROL ClickTrack] est utilisé plusieurs fois. (TGT-51921)
* Correction de l’erreur « Entrée utilisateur non valide » dans les activités VEC avec des emplacements partagés (par exemple, le sélecteur d’HEAD) et des offres identiques. (TGT-51879)
* Correction d’un problème qui entraînait le partage des modifications d’expérience entre les audiences. (TGT-51815)
* Correction des erreurs de validation lors de la création d’activités en raison de conflits d’ID de segment. Les erreurs se sont produites lorsque [!DNL Target] a détecté des activités existantes à l&#39;aide de segments anonymes. (TGT-51784)
...
* Résolution du problème entraînant l&#39;échec des demandes de GET lors de la récupération de la liste de mesures [!DNL Analytics]. (TGT-51106)
...
* Correction d’un problème en raison duquel les audiences réservées à l’activité n’étaient pas visibles dans le panneau [!UICONTROL Audiences], empêchant leur modification ou leur réutilisation. (TGT-51860)
* Correction d’un problème qui empêchait les clients [!DNL Target Standard] de créer des activités à l’aide de rapports [!UICONTROL Analytics for Target] (A4T). (TGT-51854)
...
* Correction d’un problème empêchant les mises à jour d’activité après la version [!DNL Target] 25.2.1 pour certaines activités. (TGT-51781)
...
* Correction d’un problème qui bloquait l’affichage de [!DNL Adobe Experience Platform] attributs lors de la création de nouvelles offres. (TGT-51665)
...
Pour améliorer l&#39;expérience utilisateur pour les utilisateurs [!DNL Adobe Target], cette version met à jour l&#39;interface utilisateur [!UICONTROL Offers Library].

>[!NOTE]
>
>Pour garantir un déploiement sans heurt pour tous les clients, cette version sera déployée par étapes contrôlées. La première étape a mis à niveau le groupe initial de clients cibles vers la nouvelle interface utilisateur Offres. Les étapes suivantes mettront à niveau les clients restants.
...
Entre le 22 juillet 2024 et le 15 août 2024, l&#39;équipe [!DNL Target] a optimisé la portée `__view__`, améliorant ainsi la précision des impressions d&#39;activité, des visites et des rapports sur les visiteurs. Cette optimisation vise à capturer automatiquement les données de reporting pour les propositions rendues automatiquement et devrait être transparente pour la plupart des comptes.

Cette optimisation sera activée pour tous les nouveaux clients [!DNL Adobe Experience Platform Web SDK]. Cependant, les clients qui ont migré à partir d’at.js et n’ont pas suivi les étapes de mise en œuvre ci-dessous ont l’optimisation désactivée. Nous recommandons vivement à ces clients de passer en revue leurs mises en œuvre d’ici le 3 février 2025. Passée cette date, nous activerons l’optimisation pour tous les clients. Si vous ne révisez pas et n’ajustez pas les implémentations d’ici là, les rapports peuvent être affectés, comme mentionné ci-dessous. Contactez [!DNL Adobe Customer Care] si vous devez confirmer si votre implémentation est affectée ou si vous avez besoin de plus de temps pour ajuster votre implémentation.
...
* Les spécialistes du marketing peuvent tirer parti des fonctionnalités [!DNL Customer Journey Analytics], telles que le [panneau d&#39;expérimentation](https://experienceleague.adobe.com/fr/docs/analytics-platform/using/cja-workspace/panels/experimentation){target=_blank}, pour analyser plus en détail la personnalisation de leur site Web.
...
Cette version contient les améliorations et correctifs suivants pour l&#39;extension [[!DNL Adobe Experience Cloud Editing Helper]](/help/main/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/visual-editing-helper-extension.md) de [!DNL Google Chrome] :

* Amélioration du mécanisme de chargement iFrame lors de la création sur les sites web des clients.
* Correction d’un problème qui entraînait la duplication des cookies par l’extension lors de la création dans [!UICONTROL Visual Experience Composer] (VEC).
...
* Les activités [!UICONTROL Analytics for Target] (A4T) avec des mesures d&#39;objectif de produit n&#39;affichaient pas « Produit » comme nom de colonne et la mesure de produit ne s&#39;affichait pas au format ($) dans les rapports. Il s’agissait d’un problème d’ordre cosmétique qui a été corrigé. (TGT-46995)
...
Dans le cadre des efforts continus de l&#39;équipe [!DNL Adobe Target] pour améliorer l&#39;expérience utilisateur pour les utilisateurs [!DNL Target], cette version actualise la page [!UICONTROL Activities] dans l&#39;interface utilisateur [!DNL Target]. Cette mise à jour harmonise et uniformise les modèles de conception qui étaient auparavant incohérents. Elle apporte également de nouvelles améliorations.
...
* Correction d’un problème en raison duquel les actions du compositeur d’expérience visuelle étaient appliquées dans un ordre incorrect. Dans certains cas, le VEC a appliqué certaines modifications de manière asynchrone et l&#39;ajout de modifications supplémentaires à un élément a provoqué des erreurs si cet élément s&#39;affiche après une action [!UICONTROL Insert]. Corrige également l’URL du compositeur d’expérience visuelle, qui se met à présent à jour lorsque l’utilisateur ou l’utilisatrice clique sur les liens. (TGT-45983)
...
* Correction d’un problème qui empêchait l’affichage d’une image dans le panneau [!UICONTROL Create Design] si le nom de l’image contenait des Go 18030 caractères. (TGT-44614)
...
* Correction d’un problème qui provoquait le blocage des rapports pour les activités [!UICONTROL Auto Personalization] lors de l’analyse. (TGT-44820)
...
* Correction d&#39;un problème en raison duquel un paramètre de requête était ajouté à une URL qui empêchait le chargement de la page dans [!UICONTROL Visual Experience Composer] (VEC). (TGT-44873)
...
* Suppression des options de calendrier 45 jours et 90 jours de l&#39;AP et des rapports [!UICONTROL Auto-Target] [!UICONTROL Personalization Insights] et [!UICONTROL Important Attributes] dans l&#39;interface utilisateur [!DNL Target]. En raison des schémas d’utilisation et afin d’améliorer les performances, ces périodes sont désormais obsolètes. L’interface utilisateur a été mise à jour pour prendre en compte les périodes actuellement autorisées : 15, 30 et 60 jours. (TGT-39357)
* Impossible de modifier le paramètre [!UICONTROL Same as Optimization Goal] sur la page [!UICONTROL Goals & Settings] une fois l&#39;activité en ligne. (TGT-43923)
...
* Ajout d’une option [!UICONTROL Cross-Domain] lors du téléchargement à partir de.js 2.10.0 pour autoriser ou désactiver la configuration des cookies tiers. (TGT-43674)
...
* Correction d’un problème qui empêchait [!UICONTROL Decision Offers] de fonctionner correctement dans [!UICONTROL Visual Experience Composer] (VEC). (TGT-43866)
* Correction d&#39;un problème qui provoquait l&#39;affichage d&#39;un message d&#39;erreur lors de la sélection de l&#39;objectif de conversion [!UICONTROL Clicked an Element] lors de la création d&#39;une activité [!UICONTROL Multivariate Testing] (MVT). (TGT-43842)
...
* Correction d’un problème qui empêchait les clients de modifier les offres HTML/JSON après la duplication d’expériences lors de l’utilisation de [!UICONTROL Form-Based Experience Composer]. (TGT-43633)
* Correction d&#39;un problème qui empêchait les clients de copier une activité [!UICONTROL A/B Test] d&#39;un espace de travail autre que celui par défaut vers un autre espace de travail autre que celui par défaut. (TGT-41910)
* Correction d&#39;un problème pour s&#39;assurer que les clients peuvent afficher correctement les utilisations des objets [!DNL Recommendations] (conceptions, critères, collections, etc.) dans les activités [!UICONTROL A/B Test] et [!UICONTROL Experience Targeting] (XT) qui contiennent des recommandations et également supprimer les objets de critères qui ne sont plus utilisés de l&#39;interface utilisateur [!DNL Target] et du back-end [!DNL Recommendations]. (TGT-42331)
...
* Une amélioration a été apportée à la nouvelle page [!UICONTROL Audiences] pour éviter un état incohérent entre l&#39;ancienne base de données dans laquelle les audiences étaient stockées et la nouvelle architecture qui récupère les informations directement à partir du serveur principal. (TGT-43552)
...
* Correction d’un problème qui empêchait les clients de supprimer des emplacements qui avaient des offres ad hoc dans des activités créées dans [!UICONTROL Form-Based Experience Composer]. (TGT-43315)
...
* Correction d&#39;un problème qui empêchait l&#39;affichage de la case à cocher [!UICONTROL Compatible] dans la sélection des critères lors de la création d&#39;une nouvelle activité [!UICONTROL Recommendations]. (TGT-42053)
...
Les améliorations suivantes ont été ajoutées lors de l&#39;utilisation de [!DNL Target] [!UICONTROL Audiences] avec [!DNL Adobe Experience Platform Web SDK] :
...
* Ajout dʼicônes dʼavertissement, de fenêtres contextuelles et de messages à plusieurs endroits de lʼinterface utilisateur de [!DNL Target] pour indiquer que lʼaudience a été supprimée à la source et nʼest plus disponible pour une utilisation dans les activités [!DNL Target].
   ...
   * Page de liste [!UICONTROL Activity]
   ...
   * Pages d&#39;activité [!UICONTROL Overview] :
   ...
   * Étape [!UICONTROL Targeting] du workflow de création d’activité :
...
* Correction d’un problème qui entraînait l’ouverture des rapports [!DNL Analytics] hérités au lieu de [!DNL Analysis Workspace] lorsque les clients cliquaient sur « [!UICONTROL View in Analytics] » lors de l’affichage d’un rapport. (TGT-41867)
...
* Correction d’un problème lors de l’actualisation du [!UICONTROL Audience Library] d’un espace de travail. Avant l’actualisation, les audiences de l’espace de travail actuellement sélectionné s’affichent. Après l&#39;actualisation, le [!UICONTROL Default Workspace] et son public s&#39;affichent. L’espace de travail actuel et ses audiences restent après l’actualisation. (TGT-38871)
...
* Correction d’un problème qui entraînait l’affichage d’un nombre incorrect de produits pour les exclusions [!UICONTROL Recommendations]. (TGT-39599)
...
* Correction d’un problème qui affectait les rapports [!DNL Adobe Target Premium] des utilisateurs [!UICONTROL Auto-Target] entre le 15 septembre, 14 h 2&rbrace; (PDT) et le 6 octobre, 9 h 3 (PDT). :30:25 Lors de l&#39;affichage des rapports pour les mesures de conversion affectées (configurées à l&#39;aide de l&#39;option « [!UICONTROL Viewed a page] » ou « [!UICONTROL Clicked on mbox] »), les taux de conversion sont signalés de manière incorrecte. Aucun problème de diffusion n’est connu pour le moment.
* Ajout d&#39;une colonne sélectionnable [!UICONTROL Last Updated At] dans la table [!UICONTROL Catalog Search] et d&#39;un filtre [!UICONTROL Last Updated At]. Cette amélioration permet de gagner du temps et de limiter les efforts, car il n’est pas nécessaire d’ouvrir chaque élément individuel pour voir quand il a été mis à jour pour la dernière fois. Vous pouvez également filtrer les éléments par date de dernière mise à jour.
...
| Fonctionnalité | Détails |
| --- | --- |
| ![Badge Premium](/help/main/assets/premium.png) Prise en charge d’Analytics for Target (A4T) pour les activités de ciblage automatique | Les activités [!UICONTROL Auto-Target] prennent désormais en charge [Analytics for Target](/help/main/c-integrating-target-with-mac/a4t/a4t.md).<br>Cette intégration vous permet d&#39;utiliser l&#39;algorithme de machine learning de [!UICONTROL Auto-Target] ensemble pour choisir la meilleure expérience pour chaque visiteur en fonction de son profil, de son comportement et de son contexte.<br>Si vous avez déjà [implémenté A4T](/help/main/c-integrating-target-with-mac/a4t/a4timplementation.md) pour une utilisation avec les activités de test A/B et de ciblage d&#39;expérience, c&#39;est fait !<br>Pour plus d’informations, consultez [Prise en charge d’A4T pour les activités d’affectation automatique et de ciblage automatique](/help/main/c-integrating-target-with-mac/a4t/a4t-at-aa.md). |
...
* Correction d’un problème qui entraînait l’affichage d’erreurs lors du chargement des nouvelles pages [!UICONTROL Administration] après le changement d’organisation. (TGT-37730)
* Correction d&#39;un problème d&#39;affichage qui provoquait l&#39;affichage du code client incorrect sur la page [!UICONTROL Administration > Implementation]. (TGT-37849)
* Correction d&#39;un problème qui empêchait parfois les utilisateurs d&#39;utiliser les fonctionnalités de modification dans [!UICONTROL Visual Experience Composer] (VEC) après le chargement réussi du VEC. (TGT-37162)
...
* Correction d’un problème dans les activités [!UICONTROL Auto-Allocate] lors de la sélection des mesures d’optimisation et de conversion lorsqu’un message d’erreur informait de manière incorrecte les utilisateurs de sélectionner une suite de rapports, même si une suite de rapports était déjà spécifiée. (TGT-37689)
* Correction d’un problème qui entraînait parfois l’absence de mesures sur la page [!UICONTROL Goals and Settings] après avoir navigué vers la page [!UICONTROL Targeting], puis de nouveau. (TGT-37691)
...
Nous réécrivons progressivement l’intégralité de l’interface utilisateur de [!DNL Target] à l’aide d’une nouvelle infrastructure technologique afin d’offrir de meilleures performances, de réduire le temps de maintenance requis lors de la publication de nouvelles fonctionnalités et d’améliorer l’expérience utilisateur sur l’ensemble du produit. La première section actualisée est la section [!UICONTROL Setup], renommée [!UICONTROL Administration].
...
* Personnalisez vos paramètres at.js et passez facilement en revue vos modifications (**[!UICONTROL Administration]** > **[!UICONTROL Implementation]**).
* Modifiez les paramètres de rapport améliorés, tels que la devise et le fuseau horaire par défaut, les adresses IP à exclure du rapport, etc. (**[!UICONTROL Administration]** > **[!UICONTROL Reporting]**)
...
* La ligne de sauvegarde du téléchargement CSV Recommendations comporte désormais un « &#42; » de début (guillemets doubles encadrant un astérisque) au lieu de &#42; (astérisque unique).
...
<table id="table_9554D0094421417C88548BDC97B710F5"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p><b>Afficher plusieurs objectifs/mesures :</b> vous pouvez désormais afficher plusieurs mesures dans les activités A/B et XT (Experience Targeting), à l'exception des activités A/B <a href="/help/main/c-activities/automated-traffic-allocation/automated-traffic-allocation.md#concept_A1407678796B4C569E94CBA8A9F7F5D4" format="dita" scope="local"> Allocation automatique </a> et <a href="/help/main/c-activities/auto-target/auto-target-to-optimize.md" format="dita" scope="local"> Cible automatique </a>. </p> <p>Pour plus d’informations, voir <a href="/help/main/c-reports/c-report-settings/view-multiple-metrics.md#concept_9E3C3F6F3EC1412FAF252975AC0720B7" format="dita" scope="local">Affichage de plusieurs mesures dans un rapport.</a> </p> </td> 
  </tr> 
 </tbody> 
</table>
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> at.js</span> version 0.9.6 est désormais disponible. Pour plus d’informations, voir <a href="https://experienceleague.adobe.com/docs/target-dev/developer/client-side/at-js-implementation/deploy-at-js/implement-target-without-a-tag-manager.html?lang=fr" format="dita" scope="local">Téléchargement d’at.js</a>. </p> <p>Les améliorations et corrections suivantes sont incluses dans la version 0.9.6 d’<span class="filepath">at.js</span> : </p> <p> 
     <ul id="ul_108DF85393614C69988E299485D338FD"> 
      ...
      <li id="li_02904EBAE8D3400092B762F0B28B0C86"> <p>Correction d’un problème en raison duquel les plug-ins <span class="keyword"> Target Classic </span> n’étaient pas appliqués correctement lorsque plusieurs offres par défaut étaient envoyées à une seule mbox. (TGT-22664)</p> </li> 
...
* L&#39;interface utilisateur [!DNL Target] a été mise à jour pour prendre en charge les offres de redirection dans les activités qui utilisent [!UICONTROL Analytics for Target] (A4T) comme source de rapports. Le fichier [!DNL at.js] version 0.9.6 est requis pour cette fonction. Il sera bientôt disponible.
* L’interface utilisateur de [!DNL Target] a été mise à jour à certains emplacements :

   * Dans les rapports et les activités, certaines options ([!UICONTROL Edit], [!UICONTROL Share to Feed], [!UICONTROL View Experience URLs], etc.) sont désormais accessibles en cliquant sur l&#39;icône [!UICONTROL More Options] (![icône_plus_options image](assets/icon_more_options.png))

      
   * Dans la bibliothèque [!UICONTROL Offers], les offres s’affichent désormais dans une liste plutôt que sous forme de cartes. D&#39;autres modifications mineures ont été apportées à l&#39;interface utilisateur de la bibliothèque [!UICONTROL Offers].

* Amélioration significative des performances sur les listes [!UICONTROL Activity] et [!UICONTROL Audience]. En outre, les résultats de la recherche se chargent beaucoup plus rapidement.
* « Vues » est désormais « Visites » dans les rapports [!UICONTROL Offer Level Report] pour [!UICONTROL Automated Personalization].
* [!DNL Target] prend désormais en charge le basculement des environnements (groupes hôtes) pour les activités [!UICONTROL Automated Personalization].
...
>[!NOTE]
>
>[!DNL Adobe Experience Manager] 6.2 avec FP-11577 (ou version ultérieure) prend désormais en charge les implémentations [!DNL at.js] avec son intégration [!UICONTROL Adobe Target Cloud Services]. Pour plus d’informations, reportez-vous aux sections [Feature Packs](https://experienceleague.adobe.com/docs/?lang=fr) et [Intégration à Adobe Target](https://experienceleague.adobe.com/docs/?lang=fr) de la documentation d’*Adobe Experience Manager 6.2*.
...
<table id="table_E2E4BE72BD79413A821C6A6D1A3AB0F8"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>L’interface utilisateur de l’éditeur de code a été mise à jour de manière à être plus intuitive et plus simple à utiliser. </p> <p>Pour plus d'informations, voir Éditeur de code <a href="/help/main/c-experiences/c-visual-experience-composer/c-vec-code-editor/vec-code-editor.md#concept_B3A6E9EE3A60406DB640E205EA1745B5" format="dita" scope="local"> </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* Une partie du texte de l&#39;interface utilisateur pour la fonctionnalité [!UICONTROL Category Affinity] s&#39;affiche en anglais uniquement. Les autres langues seront disponibles dans la version de [!DNL Target] de septembre.
...
* Problème avec les URL de prévisualisation pour les expériences avec redirection. Pour contourner le problème, dans Experience Composer, cliquez sur **[!UICONTROL Configure]**, choisissez **[!UICONTROL Multiple Audiences]** et ajoutez **[!UICONTROL All visitors]** comme seule audience. Continuez pour enregistrer votre activité. Ceci ne modifie en rien la diffusion de votre activité, mais permet d’obtenir un aperçu de votre travail. Ce problème sera résolu dans la version d’Adobe Target de juillet.
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Dans cette version, l’interface utilisateur a été modifiée de manière significative. Les modifications les plus importantes sont les suivantes : </p> <p> 
     ...
     </ul> </p> <p>La sélection des solutions Experience Cloud, y compris Target, a également été modifiée. Pour accéder aux services et solutions Experience Cloud, cliquez sur l’icône de menu : </p> <p> <img src="assets/menu-shell-400.png" id="image_6E9323E0EBEA41B1A7319D6BCC43E769" width="400" height="140" /> </p> <p>Pour plus d'informations sur l'accès à Target et la définition de Target comme page par défaut après la connexion à l'Experience Cloud, voir <a href="/help/main/c-intro/target-access-from-mac.md#task_5467C72DAFCB4BB583762CAAFC00A5CF" format="dita" scope="local"> Accéder à Target depuis Adobe Experience Cloud </a>. </p></td> 
  </tr> 
  <tr> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Lorsque le modèle d’une activité d’affectation automatique est prêt, les opérations suivantes ne sont pas autorisées dans l’interface utilisateur : </p> <p> 
     ...
     </ul> </p> <p>Reportez-vous à la section <a href="/help/main/c-activities/automated-traffic-allocation/automated-traffic-allocation.md#concept_A1407678796B4C569E94CBA8A9F7F5D4" format="dita" scope="local"> Attribution automatique de trafic </a> pour obtenir de la documentation sur l'affectation automatique. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
* La mise à jour Chrome version 48 est la source d’un problème qui entraîne un mauvais fonctionnement du compositeur d’expérience visuelle dans Chrome. Google recherche une solution. Pour plus d’informations, voir [https://code.google.com/p/chromium/issues/detail?id=582603](https://code.google.com/p/chromium/issues/detail?id=582603). Pour contourner ce problème :
   ...
   * Activez Enhanced Experience Composer, qui peut être configuré à partir de l’onglet **[!UICONTROL Administration]** > **[!UICONTROL Visual Experience Composer]**.
...
<table id="table_5D4C3C5695BA4A88BC65E2721CFB073A"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Examinez les détails de l’implémentation de votre page Target ainsi que l’état de diffusion des activités/expériences pour un dépannage amélioré. </p> <p>Voir <a href="/help/main/c-activities/c-troubleshooting-activities/content-trouble.md#concept_D2548B486C984B1E97ED7A72075B8EEA" format="dita" scope="local"> Dépannage de la livraison de contenu </a> pour plus d'informations. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
| Fonction/amélioration | Description |
|---|---|
| Autorisation de l’insertion et de la modification du code JavaScript | Ajout de la possibilité de modifier et d&#39;injecter du code JavaScript personnalisé dans l&#39;éditeur d&#39;expérience lorsque vous choisissez **[!UICONTROL Edit HTML]** dans le menu d&#39;actions. |
