...
Pour plus d’informations, voir [Documentation du SDK Python](https://developer.adobe.com/target/implement/server-side/python/){target=_blank} dans la variable [Guide du développeur d’Adobe Target](https://developer.adobe.com/target/).
