...
description: Découvrez comment utiliser le rapport Contribution de l’emplacement pour les activités  [!DNL Target] [!UICONTROL Ciblage d’expérience] qui présentent les performances de chaque élément et de chaque offre.
