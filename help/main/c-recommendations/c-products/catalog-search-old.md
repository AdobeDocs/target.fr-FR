...
1. Saisissez un terme de recherche dans le champ **[!UICONTROL Rechercher des produits]**.
...
Vous pouvez utiliser [!UICONTROL Recherche avancée] pour affiner davantage vos résultats de recherche ou pour enregistrer vos résultats de recherche en tant que [collection](/help/main/c-recommendations/c-products/collections.md) ou [exclusion](/help/main/c-recommendations/c-products/exclusions.md).
...
Vous pouvez créer des [collections](/help/main/c-recommendations/c-products/collections.md) ou [exclusions](/help/main/c-recommendations/c-products/exclusions.md) à l’aide de la [!UICONTROL Recherche avancée] sur la page [!UICONTROL Recherche catalogue] ([!UICONTROL Recommendations] > [!UICONTROL Recherche catalogue] > [!UICONTROL Recherche avancée]).
...
Vous pouvez modifier temporairement les filtres et colonnes disponibles sur la page [!UICONTROL Recherche catalogue] pour la session en cours.

### Modification des filtres

Vous pouvez ajouter des facettes de filtre supplémentaires à la page [!UICONTROL Recherche catalogue].
...
1. Sélectionnez les facettes de recherche souhaitées (identifiant, nom, message, etc.), puis cliquez sur **[!UICONTROL Enregistrer]**.
...
Vous pouvez temporairement modifier les colonnes actives de la page [!UICONTROL Recherche catalogue].

1. Cliquez sur le lien **[!UICONTROL Colonnes]**.

   ![Options des colonnes](/help/main/c-recommendations/c-products/assets/columns.png)

1. (Conditionnel) Pour réorganiser l’ordre des colonnes actives, faites glisser et déposez les colonnes de la section **[!UICONTROL Colonnes actives]** dans l’ordre souhaité.

1. (Conditionnel) Faites glisser des éléments du **[!UICONTROL Colonnes actives]** vers le **[!UICONTROL Colonnes inactives]** (et vice versa), selon vos besoins.
