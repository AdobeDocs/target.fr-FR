...
description: Découvrez comment utiliser  [!DNL Recommendations] [!UICONTROL Catalog Search] pour localiser des produits ou du contenu, supprimer des éléments de votre catalogue, etc.
title: Comment utiliser  [!DNL Recommendations] [!UICONTROL Catalog Search] ?
...
1. (Facultatif) Vous pouvez affiner votre recherche en sélectionnant une option de recherche dans le menu Options qui s&#39;affiche lorsque vous cliquez sur la flèche vers le bas dans le champ [!UICONTROL Search In].
...
Vous pouvez afficher les détails d&#39;un élément individuel, notamment son ID, son nom, son message, sa catégorie, etc.

1. Cliquez sur un élément dans les résultats de la recherche pour afficher ses détails.
...
Toutes les modifications que vous apportez sont persistantes d’une session à l’autre.
