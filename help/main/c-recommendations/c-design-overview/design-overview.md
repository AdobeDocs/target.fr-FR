...
description: Découvrez comment utiliser des conceptions dans  [!DNL Target] Recommendations pour définir la manière dont les recommandations apparaissent sur une page (1X4, 1X6, 2X2, etc.).
...
[!DNL Target] pouvez fournir l’aspect complet de vos recommandations, comme illustré ci-dessous. La conception peut inclure du code HTML, JavaScript et CSS. Cette conception est appelée conception 4 x 1 : quatre espaces dans une ligne.
