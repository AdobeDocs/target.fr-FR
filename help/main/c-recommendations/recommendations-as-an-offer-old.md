...
1. Lors de la création d’une [expérience](/help/main/c-experiences/c-visual-experience-composer/viztarget-options.md), cliquez sur l’élément auquel vous souhaitez ajouter une recommandation en tant qu’offre, cliquez sur **[!UICONTROL Remplacer le contenu]** ( ![icône Remplacer le contenu](/help/main/assets/icons/Switch.svg) ), puis sélectionnez **[!UICONTROL Recommandation]**.

   ![Insérer une recommandation en tant qu’offre](/help/main/c-recommendations/t-create-recs-activity/assets/recs-as-offer.png)

1. Dans le rail [!UICONTROL Recommandation] sur le côté droit, cliquez sur **[!UICONTROL Sélectionner une recommandation]** pour afficher la boîte de dialogue [!UICONTROL Sélectionner des critères].

1. Cliquez sur **[!UICONTROL Créer des critères]** ou sélectionnez un critère existant.

1. (Facultatif) Cliquez sur l’icône **[!UICONTROL Filtrer]** ( ![Icône Filtrer](/help/main/assets/icons/Filter.svg) ) pour effectuer une sélection parmi les options suivantes afin d’afficher les critères de recommandations populaires par type de page :
...
1. Cliquez sur **[!UICONTROL Créer des critères]** ou sélectionnez un [critère](/help/main/c-recommendations/c-algorithms/algorithms.md) existant, puis cliquez sur **[!UICONTROL Suivant]** pour afficher la boîte de dialogue [!UICONTROL Sélectionner la conception].

1. Cliquez sur **[!UICONTROL Créer une conception]** ou sélectionnez une [conception](/help/main/c-recommendations/c-design-overview/design-overview.md) existante, puis cliquez sur **[!UICONTROL Suivant]**.
...
1. Dans le rail [!UICONTROL Recommandation], cliquez sur l’icône **[!UICONTROL Modifier]** ( ![icône Modifier](/help/main/assets/icons/Edit.svg) ) en regard de [!UICONTROL Nom du critère], [!UICONTROL Nom de la conception] ou [!UICONTROL Nom de la collection] pour modifier l’élément.

## Supprimer une offre de recommandations

1. Cliquez sur l’icône **[!UICONTROL Supprimer]** ( ![icône Supprimer](/help/main/assets/icons/Delete.svg) ) en haut du panneau [!UICONTROL Recommandation].

### Affichage du statut de l’offre de recommandations {#status}

L’état des offres de recommandations (algorithme) s’affiche au bas de la page [!UICONTROL Aperçu] de l’activité pour les tests A/B et les activités de ciblage d’expérience (XT) contenant des offres de recommandations :
