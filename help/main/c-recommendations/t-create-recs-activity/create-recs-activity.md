...
1. Spécifiez une URL d’activité, puis cliquez sur **[!UICONTROL Create]**.
   ...
   Lorsque vous cliquez sur [!UICONTROL Create], le compositeur d’expérience visuelle s’ouvre et affiche votre page. Vous pouvez remplacer un élément actuel par des recommandations ou insérer des recommandations.
