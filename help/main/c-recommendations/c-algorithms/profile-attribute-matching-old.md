...
description: Découvrez comment effectuer un filtrage dynamique dans Adobe [!DNL Target] Recommendations en comparant des éléments (entités) à une valeur du profil de l’utilisateur.
