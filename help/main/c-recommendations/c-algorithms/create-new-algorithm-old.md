...
>[!NOTE]
>
>Si vous avez sélectionné **[!UICONTROL Basé sur un élément]**/ **[!UICONTROL Média avec des attributs similaires]** comme type d’algorithme et algorithme, vous avez la possibilité de définir des règles de similarité de contenu.
