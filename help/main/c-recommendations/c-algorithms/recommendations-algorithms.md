...
* [!UICONTROL Meilleurs vendeurs par attribut de profil]
...
* [!UICONTROL Les plus consultés par attribut de profil] et [!UICONTROL Meilleurs vendeurs par attribut de profil] classent également les articles par nombre d’achats ou d’affichages agrégés, mais la clé de regroupement est un attribut de profil du visiteur , tel que le pays, la région ou le niveau d’adhésion, au lieu d’une propriété d’article. Le nombre de chaque session est attribué à la valeur de profil que le visiteur possédait au moment de l’interaction, et non à un attribut de l’élément. Le résultat est un ensemble de listes de recommandations indexées par les valeurs distinctes de cet attribut de profil.
