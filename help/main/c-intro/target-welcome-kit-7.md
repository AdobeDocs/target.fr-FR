...
Vous pouvez configurer une activité de [ciblage d’expérience](/help/main/c-activities/t-experience-target/experience-target.md) (XT) qui cible une audience spécifique que vous jugez précieuse avec une offre ou une expérience dont vous êtes sûr qu’elle éveillera l’intérêt.

Exemple : une compagnie aérienne cible ses membres de niveau platine avec une offre spéciale doublant les points lors du prochain achat d’un billet d’avion pour les récompenser et les fidéliser davantage.
...
Nous avons inclus le planificateur d’activités [Adobe Target](/help/main/assets/activity-planner.pdf) en tant que PDF autonome que vous pouvez enregistrer et réutiliser à l’infini. Cliquez sur le lien pour afficher le fichier PDF. Effectuez un clic droit pour télécharger le fichier PDF.
...
![Planificateur d’activités Adobe Target](/help/main/c-intro/assets/activity-planner.png)

Voici le type de réflexion qui intervient dans chaque zone du planificateur :

### Quelles sont les améliorations possibles ?

Sélectionnez le canal ou le point de contact à améliorer. Ajoutez l’URL de l’élément ou décrivez-le. Dans ce cas, vous ajoutez l’URL de la page web pour laquelle vous prévoyez de créer une variation de test ou une expérience personnalisée.
