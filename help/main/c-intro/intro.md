...
description: Découvrez les principes de base de l'Adobe  [!DNL Target] Standard and Adobe [!DNL Target] Premium. [!DNL Target] Premium inclut des fonctionnalités avancées non disponibles dans le produit standard.
...
[!DNL Target Standard] est le front-end d’[!DNL Adobe Target] qui vous permet de créer et de gérer visuellement des tests A/B et des activités de ciblage selon des règles. [!DNL Target Standard] prend en charge l’insertion de code personnalisé dans et hors du workflow [!UICONTROL Visual Experience Composer] (VEC). [!DNL Target Standard] offre une stratégie de mise en oeuvre simplifiée avec vos propriétés numériques. Une seule ligne de code sur chaque page gère toutes les communications requises entre votre site et [!DNL Target].
...
Tous les [!DNL Target Premium] articles des guides [!DNL Target] incluent le badge [!UICONTROL Premium] en haut de chaque page ou en ligne près du texte concerné. Le badge [!UICONTROL Premium] peut être cliqué et comprend un lien vers cette section.

**[!DNL Target Premium]comprend les fonctionnalités suivantes :**

### Automated Personalization

[Automated Personalization](/help/main/c-activities/t-automated-personalization/automated-personalization.md#task_8AAF837796D74CF893CA2F88BA1491C9) (AP) fournit des algorithmes de machine learning élaborés visant à renforcer les expériences personnalisées et à améliorer les taux de conversion des expériences digitales.

[!UICONTROL Automated Personalization] enregistre l’activité des visiteurs sur le site, créant un profil des visiteurs afin que le contenu puisse être ciblé sur des visiteurs similaires. AP suit les réactions face au contenu, à la fois pour les individus et pour la population dans son ensemble. AP utilise ensuite des méthodes de modélisation complexes pour cibler automatiquement chaque individu. AP prend en compte tout ce qui est connu sur chaque visiteur.

[!UICONTROL Automated Personalization] apprend par lui-même et nécessite une analyse humaine minimale. Totalement automatisé, AP apprend en permanence. Le système crée des modèles et identifie automatiquement les produits susceptibles d’intéresser un visiteur. Chaque fois qu’un visiteur interagit avec le site, des informations sont collectées et stockées dans son profil. De nombreux algorithmes sont disponibles afin de fournir le meilleur modèle pour votre système.

### Ciblage automatique

Le [ciblage automatique](/help/main/c-activities/auto-target/auto-target-to-optimize.md) s’appuie sur un machine learning avancé pour identifier plusieurs expériences hautement performantes définies par des spécialistes marketing. [!UICONTROL Auto-Target] diffuse ensuite l’expérience la plus personnalisée à chaque visiteur. La diffusion est basée sur les profils individuels des clients et le comportement des visiteurs précédents ayant des profils similaires. [!UICONTROL Auto-Target] permet de personnaliser le contenu et de générer des conversions.

### Recommendations

Les activités [Recommendations](/help/main/c-recommendations/recommendations.md#concept_7556C8A4543942F2A77B13A29339C0C0) affichent automatiquement les produits ou le contenu susceptibles d’intéresser votre clientèle selon l’activité antérieure des utilisateurs et utilisatrices. [!UICONTROL Recommendations] aide à diriger les clients vers des éléments pertinents dont ils ne seraient pas informés autrement.
...
Les articles des guides [!DNL Target] décrivant les fonctionnalités de Beta incluent le badge Beta en haut de chaque page ou en ligne près du texte concerné. Le badge Beta peut être cliqué et comprend un lien vers cette section.
...
## Experience League : Adobe [!DNL Target] kit de bienvenue {#kit}
