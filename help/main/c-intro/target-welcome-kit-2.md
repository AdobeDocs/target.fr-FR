...
Avec une activité de personnalisation, vous offrez une expérience digitale adaptée à un groupe spécifique ou à chaque visiteur. [!DNL Target] offre les fonctionnalités de personnalisation suivantes : ciblage d’expérience, ciblage automatique, Automated Personalization et Recommandations.
...
| Canal | Détails |
| --- | --- |
| Site web | [!DNL Target] peut être utilisé pour exécuter des activités A/B Testing, Multivariate Testing, Ciblage d’expérience, Affectation automatique, Ciblage automatique, Automated Personalization et Recommandations sur les pages de vos sites web comportant plusieurs pages, applications monopages et sites web mobiles afin d’améliorer l’engagement des visiteurs/visiteuses et des clientes/clients, d’augmenter les conversions et les recettes. |
...
Notre console d’administration permet de fournir aux personnes appropriées les rôles adéquats et les niveaux d’accès et d’autorisations associés à [!DNL Target]. Pour les utilisateurs de , nous proposons une gouvernance et un contrôle plus détaillés
avec les [!UICONTROL autorisations d’Enterprise].
