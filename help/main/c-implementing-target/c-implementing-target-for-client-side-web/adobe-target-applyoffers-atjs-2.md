...
>[!NOTE]
>
>Consultez la [Documentation de l’API de diffusion](https://developer.adobe.com/target/before-administer/) pour plus d’informations sur les types acceptables pour tous les champs répertoriés ci-dessous.
