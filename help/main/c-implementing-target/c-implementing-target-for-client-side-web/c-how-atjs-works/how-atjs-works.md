...
Voir [Mise à niveau d’at.js 1.x vers at.js 2.x](https://developer.adobe.com/target/implement/client-side/atjs/target-atjs-versions/){target=_blank} pour plus d’informations sur les différences introduites dans la version 2.0 à partir de 1.*x*.
