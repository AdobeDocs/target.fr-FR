...
description: Utilisez la fonction adobe.target.getOffers() et ses options pour l’Adobe [!DNL Target] bibliothèque at.js pour déclencher les demandes d’obtention de plusieurs [!DNL Target] offres. (at.js 2.x)
