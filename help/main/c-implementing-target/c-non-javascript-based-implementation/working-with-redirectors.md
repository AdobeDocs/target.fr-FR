...
1. Créez la campagne.
   ...
   Consultez les [Implémentations non basées sur JavaScript](https://developer.adobe.com/target/implement/email/) pour connaître la configuration appropriée permettant d’atteindre vos objectifs.
