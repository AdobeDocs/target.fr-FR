...
description: Comment créer des dossiers dans la bibliothèque [!UICONTROL Offres] ?
...
1. Cliquez sur **[!UICONTROL Créer un dossier]**.
...
1. Spécifiez un **[!UICONTROL titre]** descriptif pour le dossier.
...
1. (Facultatif) Spécifiez un **[!UICONTROL Nom]** descriptif.
1. (Facultatif) Sélectionnez **[!UICONTROL Privé]** pour spécifier que le dossier est privé afin que seul vous puissiez le voir et son contenu.
1. (Facultatif) Sélectionnez **[!UICONTROL Réorganiser dans la vue Liste]** pour indiquer que vous pouvez, ainsi que d’autres personnes, réorganiser la position du dossier dans la vue [!UICONTROL Liste].
