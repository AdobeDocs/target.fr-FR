...
Les sections suivantes décrivent les options disponibles dans le compositeur d’expérience visuelle mis à jour pour une activité de test [!UICONTROL A/B]. Les options disponibles varient en fonction du type d’activité.

### Rail [!UICONTROL Expériences]

Le rail [!UICONTROL Expériences] s’affiche dans le rail de gauche du compositeur d’expérience visuelle.

![Rail Expériences](/help/main/c-experiences/c-visual-experience-composer/assets/experiences-panel.png)

Vous pouvez afficher, créer, renommer ou supprimer des expériences à l’aide du rail [!UICONTROL Expériences].

Les options suivantes sont disponibles dans le rail [!UICONTROL Expériences] :

* **Afficher une expérience** : pour afficher une expérience, cliquez sur l’expérience souhaitée pour l’afficher dans la zone de travail [!UICONTROL Conception].
* **Ajouter une expérience** : cliquez sur l’icône **[!UICONTROL Ajouter]** ( ![Ajouter une icône](/help/main/assets/icons/Add.svg) ) pour ajouter une nouvelle expérience. Configurez la nouvelle expérience selon vos besoins.
* **Renommer une expérience** : cliquez sur l’icône **[!UICONTROL Renommer]** ( ![Icône Renommer](/help/main/assets/icons/Rename.svg) ) pour afficher la boîte de dialogue [!UICONTROL Renommer l’expérience]. Indiquez le nouveau nom, puis cliquez sur **[!UICONTROL Enregistrer]**.
* **Dupliquer, supprimer ou rediriger une expérience** : cliquez sur l’icône **[!UICONTROL Plus d’actions]** ( ![icône Plus d’actions](/help/main/assets/icons/MoreSmall.svg) ), puis choisissez **[!UICONTROL Dupliquer]**, **[!UICONTROL Supprimer]** ou **[!UICONTROL Rediriger vers l’URL]**.

### Paramètres/configuration de l’activité {#settings}

Cliquez sur l’icône [!UICONTROL Configurer] ( ![Icône Configurer](/help/main/assets/icons/Setting.svg) ) affichée au-dessus de la zone de travail [!UICONTROL Conception] pour afficher le menu des propriétés de l’activité.
...
* **[!UICONTROL Propriétés]** : attribuez des propriétés à l’activité ou supprimez des propriétés de l’activité. [!UICONTROL Propriétés] est une fonctionnalité ([[!DNL Target Premium]](/help/main/c-intro/intro.md#premium). Pour plus d’informations, voir [Autorisations des utilisateurs d’Enterprise](/help/main/administrating-target/c-user-management/property-channel/property-channel.md).
* **[!UICONTROL Diffusion de page]** : incluez la même expérience sur des pages similaires de votre site. Utilisez un modèle de page pour structurer vos pages, ou si vos pages contiennent des éléments similaires, pour tester des variations dans des éléments de page à structure similaire ou sur l’ensemble de votre domaine. Pour plus d’informations, voir [Inclure la même expérience sur des pages similaires](/help/main/c-experiences/c-visual-experience-composer/temtest.md).
* **[!UICONTROL Préférences du site]** : configurez les préférences de votre site pour spécifier comment générer [!DNL Target] sélecteurs CSS. Pour plus d’informations, voir _Sélecteurs CSS_ dans [Configuration du [!UICONTROL compositeur d’expérience visuelle]](/help/main/administrating-target/visual-experience-composer-set-up.md).
...
Utilisez le mode [!UICONTROL Parcourir] pour parcourir votre site et sélectionner la vue ou la page à mettre à jour. Revenez au mode [!UICONTROL Conception] pour ajouter ou modifier vos modifications.

### [!UICONTROL Annuler]/[!UICONTROL Rétablir]

Vous pouvez annuler les modifications effectuées en cliquant sur l’icône [!UICONTROL Annuler] ( ![icône Annuler](/help/main/assets/icons/Undo.svg) ).

![Icône Annuler dans le VEC](/help/main/c-experiences/c-visual-experience-composer/assets/undo.png)

Pour rétablir une action, développez le groupe de boutons Annuler/[!UICONTROL Rétablir] et choisissez [!UICONTROL Rétablir].

### Rail [!UICONTROL Composants]

Vous pouvez ajouter plusieurs composants à votre page web et les modifier selon vos besoins à l’aide du nouveau rail [!UICONTROL Composants].

![Rail Composants](/help/main/c-experiences/c-visual-experience-composer/assets/components-panel.png)

>[!NOTE]
>
>Si le rail [!UICONTROL Modifications] s’affiche dans cette zone au lieu du rail [!UICONTROL Composants], cliquez sur l’icône **[!UICONTROL Afficher les composants]** ( ![Icône Afficher les composants](/help/main/assets/icons/Add.svg) ). L’icône [!UICONTROL Afficher les composants] ( ![Afficher l’icône des composants](/help/main/assets/icons/Add.svg) ) et l’icône [!UICONTROL Afficher les modifications] ( ![Afficher le rail des modifications](/help/main/assets/icons/History.svg) ) agissent comme des bascules pour afficher les options appropriées.
>
>Pour réduire le rail [!UICONTROL Composants] et agrandir la zone de travail [!UICONTROL Conception] alors que le rail [!UICONTROL Composants] est ouvert, cliquez sur l’icône ( ![icône Afficher les composants](/help/main/assets/icons/Add.svg) ).
...
Pour ouvrir le rail [!UICONTROL Modifications], cliquez sur l’icône [!UICONTROL Afficher les modifications] ( ![Afficher le rail Modifications](/help/main/assets/icons/History.svg) ) dans le rail [!UICONTROL Composants].

![Rail Modifications](/help/main/c-experiences/c-visual-experience-composer/assets/modifications-panel.png)

>[!NOTE]
>
>L’icône [!UICONTROL Afficher les composants] ( ![Afficher l’icône des composants](/help/main/assets/icons/Add.svg) ) et l’icône [!UICONTROL Afficher les modifications] ( ![Afficher le rail des modifications](/help/main/assets/icons/History.svg) ) agissent comme des bascules pour afficher les options appropriées.
>
>Pour réduire le rail [!UICONTROL Modifications] et agrandir la zone de travail [!UICONTROL Conception] alors que le rail [!UICONTROL Modifications] est ouvert, cliquez sur l’icône [!UICONTROL Afficher les modifications] ( ![Afficher le rail des modifications](/help/main/assets/icons/History.svg) ).
...
Lorsque vous cliquez sur un élément de page dans la zone de travail [!UICONTROL Conception], un menu affiche les options disponibles pour ce type d’élément. En outre, un chemin d’accès DOM s’affiche au bas de la page, ce qui vous permet de naviguer facilement dans la structure de la page.
...
>[!NOTE]
>
>Les options disponibles dépendent du type d’activité et de l’élément que vous créez ou modifiez. Pour plus d’informations sur la modification des images et des offres dans une activité [!UICONTROL Test A/B], consultez [Modification d’éléments à l’aide de la zone de travail [!UICONTROL Conception]](#design) ci-dessous.

### Rail [!UICONTROL Propriétés]

Le rail [!UICONTROL Propriétés] vous permet de modifier les propriétés des éléments sélectionnés sur la page, qu’il s’agisse d’éléments HTML ou d’objets spécifiques à [!DNL Target], tels que des recommandations ou des offres.

![Rail Propriétés](/help/main/c-experiences/c-visual-experience-composer/assets/properties-panel.png)

Cliquez sur les icônes en haut du rail pour modifier le code d’HTML ou supprimer, dupliquer ou masquer des éléments. Les modifications s’affichent dans le rail [!UICONTROL Modifications].

Le rail [!UICONTROL Propriétés] est réductible dans le rail de droite pour vous permettre de masquer la zone de travail de conception et d’agrandir cette dernière. Cliquez sur l’icône [!UICONTROL Afficher/masquer les propriétés] ( ![Icône Propriétés](/help/main/assets/icons/Propertie.svg) ) située à droite du rail pour réduire ou afficher le rail [!UICONTROL Propriétés].

## Modifier des éléments à l’aide de la zone de travail [!UICONTROL Conception] {#design}

Les sections suivantes vous montrent comment modifier des images et du texte dans la zone de travail [!UICONTROL Conception]. La zone de travail de conception, ainsi que les rails Composants, Modifications et Propriétés vous fournissent des outils puissants pour vous permettre de créer facilement des expériences pour vos activités.

### Options d’image

Si vous cliquez sur une image dans une activité [!UICONTROL Test A/B], le compositeur d’expérience visuelle ressemble à l’illustration suivante :
...
Sélectionnez des composants dans le cadre [!UICONTROL Composants] sur le côté gauche pour insérer les éléments suivants :
...
Le volet [!UICONTROL Propriétés] sur le côté droit permet de configurer plus en détail les propriétés de l’image.
...
* Configurez la taille de l’image (hauteur et largeur). Cliquez sur [!UICONTROL Afficher les options avancées] pour configurer la taille minimale et maximale, la largeur, la hauteur, le débordement et l’ajustement de l’objet de l’image.
...
* Configurez les effets de l’élément (opacité). Cliquez sur [!UICONTROL Afficher les options avancées] pour configurer les valeurs de sépia, niveaux de gris, contraste, luminosité et flou de l’image. Vous pouvez également inverser ou faire pivoter l’image.
* Configurez les styles intégrés de l’image.

### Options de texte

Si vous cliquez sur du texte dans une activité [!UICONTROL Test A/B], le compositeur d’expérience visuelle ressemble à l’illustration suivante :
...
Cliquez sur l’icône [!UICONTROL Afficher les modifications] ( ![Afficher l’icône Modifications](/help/main/assets/icons/History.svg) ) pour afficher les modifications apportées à l’expérience.
...
Le rail [!UICONTROL Propriétés] sur le côté droit permet de configurer plus en détail les propriétés du texte.
...
* Configurez la taille de la zone de texte (hauteur et largeur). Cliquez sur [!UICONTROL Afficher les options avancées] pour configurer la taille minimale et maximale de la zone de texte, sa largeur, sa hauteur, son débordement et l’ajustement de l’objet.
...
* Configurez l’espacement de l’élément, y compris la marge et la marge intérieure.
* Configurez les effets de l’élément (opacité). Cliquez sur [!UICONTROL Afficher les options avancées] pour configurer les valeurs de sépia, niveaux de gris, contraste, luminosité et flou de l’image. Vous pouvez également inverser ou faire pivoter le texte.
...
Si le chemin d’accès DOM n’apparaît pas, cliquez sur l’icône [!UICONTROL Afficher DOM] ( ![Afficher l’icône DOM](/help/main/assets/icons/LayersBringToFront.svg) ).
