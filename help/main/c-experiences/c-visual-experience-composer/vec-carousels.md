...
description: Découvrez comment créer un carrousel qui peut être modifié dans l’Adobe [!DNL Target] compositeur d’expérience visuelle (VEC).
...
Cette rubrique explique comment créer un carrousel qui peut être modifié dans le [!DNL Adobe Target] [!UICONTROL Compositeur d’expérience visuelle] (VEC).
