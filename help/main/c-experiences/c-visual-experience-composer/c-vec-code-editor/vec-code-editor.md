...
1. Dans la liste déroulante **[!UICONTROL Modifications Type]** , choisissez le type souhaité :
...
Le panneau **[!UICONTROL Custom Code]** contient le code qui est exécuté au début du chargement de la page.
