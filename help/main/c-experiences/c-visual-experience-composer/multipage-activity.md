...
description: Découvrez comment créer une activité multi-page dans Adobe [!DNL Target] permet de créer un article sur plusieurs pages, avec une conception spécifique à chaque page.
...
1. Cliquez sur **[!UICONTROL Ajouter des pages supplémentaires]**.
   ...
   ![image multi-page_nav](assets/multipage_nav.png)
...
1. Utilisez la barre de navigation pour indiquer vos pages et définir la page par défaut.
   ...
   ![image multi-page_menu](assets/multipage_menu.png)
