...
1. Lors de la [création d’une activité [!UICONTROL A/B Test]](/help/main/c-activities/t-test-ab/t-test-create-ab/test-create-ab.md), sur la page **[!UICONTROL Targeting]**, cliquez sur la commande **[!UICONTROL Traffic Allocation]**, puis choisissez la méthode d’affectation du trafic souhaitée dans le volet de droite.
...
1. Sélectionnez **[!UICONTROL Adobe Analytics]** pour votre **[!UICONTROL Reporting Source]** sur la page **[!UICONTROL Goals & Settings]** , sélectionnez l’entreprise et la suite de rapports correspondant à l’objectif d’optimisation souhaité.
