...
**Dernière mise à jour : 29 mai 2025 ( [Mises à jour de la documentation : voir les modifications](r-release-notes/doc-change.md) )**

>[!BEGINTABS]

>[!TAB Nouveautés]

**[!DNL Target]25.5.4 est en ligne !**

Publiée le 29 mai 2025, cette mise à jour apporte de nouvelles améliorations à l’interface utilisateur et à la documentation. Plongez et explorez les nouveautés !
...
>[!TAB Documentation de Target]

En plus de ce guide, les guides [!DNL Adobe Target] suivants sont également disponibles :

- [[!UICONTROL Adobe Target Developer Guide]](https://experienceleague.adobe.com/fr/docs/target-dev/developer/overview){target=_blank}
- [[!UICONTROL Adobe Target Tutorials]](https://experienceleague.adobe.com/fr/docs/target-learn/tutorials/overview){target=_blank}

>[!ENDTABS]

>[!IMPORTANT]
>
>Le déploiement de la nouvelle interface utilisateur de [!DNL Target] s’est terminé le 27 mai 2025. Tous les clients ont désormais accès à la dernière version de l’interface utilisateur. À compter du 22 juin 2025, le bouton (bascule) de version de l’interface utilisateur sera supprimé. Tous les utilisateurs passeront définitivement à la nouvelle interface, sans possibilité de revenir à la version précédente. Pour plus d’informations, voir [Obsolescence du bouton (bascule) de version de l’interface utilisateur Target](/help/main/r-release-notes/release-notes.md#toggle).
