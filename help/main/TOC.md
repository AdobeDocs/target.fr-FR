...
+ Intégration de Target à Experience Cloud {#integrate}
   ...
   + Intégration de Target à Adobe Experience Manager (AEM) {#aem}
      + [Présentation de l’intégration de Target à Adobe Experience Manager (AEM)](/help/main/c-integrating-target-with-mac/aem/aem-target-integration.md)
...
+ Offres et expériences {#experiences}
   ...
   + Offres {#offers}
      ...
      + [AEM d’expérience et de fragments de contenu](c-experiences/c-manage-content/aem-experience-fragments.md)
+ Rapports {#reports}
