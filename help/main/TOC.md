---
user-guide-title: Guide du professionnel d’Adobe Target
...
+ Intégration de Target à Experience Cloud {#integrate}
   ...
   + [Intégration de Target à Adobe Experience Manager](/help/main/c-integrating-target-with-mac/aem-target-integration.md)
...
+ Rapports {#reports}
   ...
   + Rapports de personnalisation {#personalization-reports}
      ...
      + [Offrir des groupes de génération de rapports dans Automated Personalization](/help/main/c-reports/personalization-reports/offer-reporting-groups-in-automated-personalization.md)
