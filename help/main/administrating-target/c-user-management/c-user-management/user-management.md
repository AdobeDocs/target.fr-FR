...
>
>Vous pouvez déterminer si votre organisation dispose d’une licence [!UICONTROL Standard] ou [!UICONTROL Premium] en cliquant sur le lien [!UICONTROL Administration] situé en haut de l’interface utilisateur de [!DNL Target].
>
>* **[!DNL Target][!UICONTROL Standard] Clients** : si l’onglet [!UICONTROL Users] ([!UICONTROL Administration > Users]) s’affiche (et non l’onglet **[!UICONTROL Properties]**), votre organisation dispose d’une licence [!DNL Target] [!UICONTROL Standard]. Les clients [!DNL Target] [!UICONTROL Standard] doivent suivre les instructions de cet article pour ajouter des utilisateurs et attribuer des autorisations dans [!DNL Adobe Admin Console].
>
>* **[!DNL Target]Clients Premium** : si l’onglet [!UICONTROL Users] et l’onglet [!UICONTROL Properties] ([!UICONTROL Administration > Properties]) s’affichent, votre organisation dispose d’une licence [!DNL Target] Premium. Les clients [!DNL Target] Premium doivent suivre les instructions données dans [Autorisations des utilisateurs de société](/help/main/administrating-target/c-user-management/property-channel/property-channel.md) et dans [Configurer les autorisations de société](/help/main/administrating-target/c-user-management/property-channel/properties-overview.md) pour ajouter des utilisateurs et attribuer des autorisations dans [!DNL Adobe Admin Console].
>
...
Les nouveaux utilisateurs ne seront pas répertoriés sur la page [!UICONTROL Users] tant qu’ils ne se seront pas connectés à l’aide de leur compte [!DNL Adobe Experience Cloud], puis se seront connectés à [!DNL Target].

Par défaut, tous les utilisateurs de [!DNL Target] commencent avec les autorisations [!UICONTROL Observer] .

Les utilisateurs administrateurs sont identifiés dans la liste [!UICONTROL Users]. Pour faire changer votre niveau d’accès, contactez l’un des administrateurs système.
...
1. [Dans l’Admin Console](/help/main/administrating-target/c-user-management/c-user-management/user-management.md#section_79796E0227D048F59BAE0AB02E544EBE), cliquez sur **[!UICONTROL Users]** > **[!UICONTROL Users]** pour créer de nouveaux utilisateurs ou modifier des utilisateurs existants.
...
1. [Dans l’Admin Console](/help/main/administrating-target/c-user-management/c-user-management/user-management.md#section_79796E0227D048F59BAE0AB02E544EBE), cliquez sur **[!UICONTROL Users]** > **[!UICONTROL User Groups]** pour créer de nouveaux groupes d’utilisateurs ou modifier des groupes existants.
1. Suivez les instructions des articles [Gestion des utilisateurs et des groupes dans Experience Cloud](https://helpx.adobe.com/fr/enterprise/using/users.html) dans le *Guide d’utilisation d’Enterprise*.
