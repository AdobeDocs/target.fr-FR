...
Remarque : les espaces de travail sont appelés [!UICONTROL profils de produit] dans la [!DNL Adobe Admin Console for Enterprise].
...
Le modèle [!DNL Target] [!UICONTROL Autorisations] dispose des rôles d’autorisation suivants (Observateur, Éditeur, Approbateur et Observateur). Le rôle d’observateur n’apparaît pas dans les illustrations de cet article.
...
Le nouveau modèle [!DNL Target] [!UICONTROL Autorisations] dispose des mêmes trois rôles d’autorisation (Observateur, Éditeur et Approbateur). Cependant, vous pouvez attribuer les rôles d’autorisation d’un utilisateur séparément pour des pages, propriétés ou sites individuels, comme illustré ci-dessous :
...
Si vous faites partie d’une organisation multinationale, vous pouvez disposer d’un espace de travail pour vos pages web, propriétés ou sites européens et d’un autre espace de travail pour vos pages web, propriétés ou sites américains.
Après une réorganisation, en utilisant les personnages dans les illustrations ci-dessus, vous pouvez configurer des espaces de travail et des autorisations similaires à ce qui suit :
...
* **Liste d’audiences :** vous pouvez déplacer des audiences entre les espaces de travail à l’aide de l’option [!UICONTROL Plus d’actions] > [!DNL Move] de la page [!UICONTROL Audiences].
...
* Lors de l’utilisation de la vue Tous mes espaces de travail :
   ...
   * Lorsque vous sélectionnez la vue [!UICONTROL Tous mes espaces de travail], une nouvelle colonne est ajoutée à la page Activités, audiences et offres . Cette colonne répertorie l’espace de travail de l’élément et votre autorisation utilisateur associée à cet élément (observateur, éditeur ou approbateur),
...
* Tout paramètre des pages [!UICONTROL Administration] suivantes peut être contrôlé par n’importe quel [!UICONTROL approbateur] dans n’importe quel espace de travail :
...
Si un utilisateur possède plusieurs rôles et autorisations, le rôle avec les autorisations d’embauche est appliqué. Par exemple, si un utilisateur ou une utilisatrice dispose des rôles [!UICONTROL Observateur] et [!UICONTROL Approbateur], le rôle [!UICONTROL Approbateur] est appliqué.
...
Oui, vous pouvez déplacer des audiences entre les espaces de travail à l’aide de l’option [!UICONTROL Autres actions] sur la page [!UICONTROL Audiences].

1. Cliquez sur le bouton **[!UICONTROL Autres actions]** (les trois points de suspension), puis sur **[!UICONTROL Déplacer]**.

   ![Autres actions > Déplacer](/help/main/administrating-target/c-user-management/property-channel/assets/move-audience.png)

1. Sélectionnez l’espace de travail souhaité dans la liste déroulante ****, puis cliquez sur **[!UICONTROL Déplacer]**.
