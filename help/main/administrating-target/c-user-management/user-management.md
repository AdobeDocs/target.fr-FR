...
Informations sur la gestion des utilisateurs dans [!DNL Target] Standard et sur la gestion des [!UICONTROL Propriétés] et [!UICONTROL Autorisations] d’entreprise dans [!DNL Target] Premium.
...
* **Clients Target Standard :** si votre entreprise dispose d’une licence [!DNL Target] Standard, voici ce que vous verrez dans l’interface utilisateur de [!DNL Target] :
   ...
   * Vous ne *pas* voir l’onglet [!UICONTROL Propriétés] ( [!UICONTROL Administration] > [!UICONTROL Propriétés] )
...
* **Clients Target Premium :** si votre entreprise dispose d’une licence [!DNL Target] Premium, voici ce que vous verrez dans l’interface utilisateur de Target :
   ...
   * Vous ne *pas* voir l’onglet [!UICONTROL Utilisateurs] ( [!UICONTROL Administration] > [!UICONTROL Utilisateurs] )
...
L’illustration suivante présente la page [!UICONTROL Administration] pour un compte [!DNL Target Premium] :
