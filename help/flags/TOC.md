...
+ Intégration d’indicateurs {#integrate}
  ...
  + [Applications Web](guides/integrate/web-applications.md)
...
+ Critères d’audience {#audience}
  ...
  + [Création des attributs de contexte](guides/audience/creating-your-context-attributes.md)
  + [Création et utilisation d’ensembles de règles](guides/audience/creating-and-using-rule-sets.md)
...
+ Guide d’intégration {#sdk-releases}
  ...
  + [Guide d’intégration de l’extension web](guides/sdk-releases/web/web-extension-integration-guide.md)
