...
description: Kit de bienvenue Adobe Target - Chapitre 2
title: Kit de bienvenue Adobe Target - Chapitre 2
feature: intro
...
Pour une compréhension plus approfondie du moment et de la manière d&#39;utiliser chaque fonctionnalité, voir Types [d&#39;activités de](/help/c-activities/target-activities-guide.md)Cible.
...
| Affectation automatique | Identifiez l’expérience la plus performante parmi deux expériences ou plus et réaffectez automatiquement plus de trafic à l’expérience gagnante afin d’augmenter les conversions pendant que le test continue à s’exécuter et à apprendre. Utilise l&#39;intelligence artificielle alimentée par [!DNL Adobe Sensei]. [En savoir plus](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md). |
| Cible<br>automatique (Premium) | Tirez parti de l’intelligence artificielle de Adobe Sensei [!DNL Target] pour déterminer et fournir à chaque visiteur la meilleure expérience de plusieurs d’entre eux en fonction de son profil client individuel et du comportement des visiteurs précédents ayant des profils similaires. La Cible automatique permet la personnalisation à l’échelle. |
| Automated Personalization<br>(Premium) | Utilisez des algorithmes d’apprentissage automatique élaborés et l’automatisation optimisée par [!DNL Adobe Sensei] pour examiner différentes combinaisons d’images, de copies et d’autres éléments dans une offre et fournir la meilleure combinaison à chaque visiteur en fonction des objectifs commerciaux les plus performants, tels que l’augmentation des conversions ou des recettes par visiteur. [En savoir plus](/help/c-activities/t-automated-personalization/automated-personalization.md). |
...
| Autorisations<br>Enterprise (Premium) | A means of formal administering enterprise-wide user access to [!DNL Target]. Add users to [!DNL Target], assign permissions based on their roles, and create workspaces for teams based on different departments, global locations, channel, and other logical groupings. Vous pouvez attribuer aux utilisateurs les rôles d’observateur, d’éditeur, d’éditeur ou d’approbateur. [En savoir plus](/help/administrating-target/c-user-management/property-channel/property-channel.md). |

## Intégrations

[!DNL Target] peut s’intégrer à de nombreux systèmes propriétaires, secondaires et tiers. Ces intégrations peuvent s’avérer utiles pour vous permettre d’accéder aux données des visiteurs et des clients disponibles à partir de ces systèmes pour les utiliser dans la création d’audiences de test et de personnalisation. Dans [!DNL Adobe Experience Cloud]ce cadre, [!DNL Target] s&#39;intègre étroitement aux [!DNL Experience Cloud] solutions et à ses services principaux.

| Intégration | Détails |
| --- | --- |
| Adobe Experience Cloud | [!DNL Target] comporte des fonctionnalités intégrées avec d’autres [!DNL Adobe Experience Cloud] solutions pour personnaliser les expériences à grande échelle. Tirez parti de la puissance de [!DNL Target] avec [Adobe Analytics](/help/c-integrating-target-with-mac/a4t/a4t.md), les Audiences [](/help/c-integrating-target-with-mac/mmp.md)Experience Cloud, [Adobe Campaign](/help/c-integrating-target-with-mac/campaign-and-target.md), Adobe Audience Manager () et la Adobe Experience Manager ().[](/help/c-integrating-target-with-mac/audience-manager-target-integration.md)[](/help/c-experiences/c-manage-content/aem-experience-fragments.md) |
| API de cible (Premium) | [!UICONTROL Cible] offre plus de 40 API que vous pouvez utiliser pour intégrer Adobe Target à des systèmes propriétaires, secondaires et tiers. [En savoir plus](/help/api/api-overview.md). |
...
* **Méthodologie** disciplinaire Commençons-nous à tester aux bons endroits ? Par exemple, vous avez besoin d’emplacements qui ont un trafic suffisant et qui ont un impact sur les mesures importantes pour l’entreprise.
* **Configuration** adéquate Notre activité est-elle configurée pour atteindre notre objectif ? Par exemple, si nous tentons d&#39;augmenter les demandes de prêt, nous devrions cible les personnes intéressées par les prêts et mesurer les clics sur le bouton &quot;Envoyer&quot;.
