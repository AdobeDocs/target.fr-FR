...
Pour plus d’informations sur les attributs dans les exemples, voir [Attributs d’entités](../c-recommendations/c-products/entity-attributes.md#reference_3BCC1383FB3F44F4A2120BB36270387F)
...
Pour accéder aux options de [!UICONTROL configuration des recommandations], ouvrez [!DNL Target] dans [!DNL Adobe Experience Cloud], puis cliquez sur **[!UICONTROL Recommandations]** &gt; **[!UICONTROL Paramètres]**.
...
| Jeton API de recommandations | Utilisez ce jeton dans les appels à l’API de recommandations, comme l’API de téléchargement. |
