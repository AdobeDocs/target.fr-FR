...
Pour plus d’informations sur la création de critères et la définition de ses types d’algorithmes et algorithmes, voir [Création de critères](/help/c-recommendations/c-algorithms/create-new-algorithm.md).
