...
Utilisez [les événements](/help/c-implementing-target/c-implementing-target-for-client-side-web/atjs-custom-events.md) at. js personnalisés pour écouter la réponse de la mbox et lire les jetons de réponse.
