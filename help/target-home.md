...
**Dernière mise à jour : 15 juin 2020 ([Voir ce qui a changé](r-release-notes/doc-change.md))**
...
- [Didacticiels](https://docs.adobe.com/content/help/en/target-learn/tutorials/overview.html)Adobe Target : Fournit des didacticiels et des vidéos pour vous aider à tirer le meilleur parti de la Cible.
...
- [API](https://developers.adobetarget.com/api/delivery-api/)côté serveur de Cible : Décrit les ressources qui composent l’API de Diffusion d’Adobe Target.
...
- [API](https://developers.adobetarget.com/api/recommendations/)Recommandations de Cible : Décrit les ressources qui constituent l’API officielle de recommandations Adobe Target.
