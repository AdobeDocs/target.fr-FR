...
**Dernière mise à jour : 24 juillet 2020 ([voir Modifications de la documentation](r-release-notes/doc-change.md))**
...
- [Didacticiels](https://docs.adobe.com/content/help/en/target-learn/tutorials/overview.html)sur l’Adobe Target : Fournit des didacticiels et des vidéos pour vous aider à tirer le meilleur parti de la Cible.
...
- [API](https://developers.adobetarget.com/api/delivery-api/)côté serveur de Cible : Décrit les ressources qui composent l’API Adobe Target Diffusion.
...
- [API](https://developers.adobetarget.com/api/recommendations/)Recommandations de Cible : Décrit les ressources qui composent l’API de recommandations d’Adobe Target officielle.
