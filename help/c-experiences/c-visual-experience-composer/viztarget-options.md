...
La plupart des actions VEC sont prises en charge sur les événements personnalisés et dans les événements personnalisés. Les actions suivantes ne sont pas disponibles :
