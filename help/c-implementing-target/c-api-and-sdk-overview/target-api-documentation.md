...
description: Découvrez comment passer des API héritées Adobe [!DNL Target] classiques aux nouvelles API sur Adobe I/O.
...
# Transition des [!DNL Target] API héritées vers l’Adobe I/O
