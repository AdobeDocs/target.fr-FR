...
description: Utilisez les fonctions mboxDefine() et mboxUpdate() pour la bibliothèque JavaScript Adobe [!DNL Target] at.js pour définir ou mettre à jour une mbox. (at.js 1.x)
