...
description: Utilisez la fonction adobe.cible.triggerView() pour la bibliothèque JavaScript Adobe [!DNL Target] at.js à utiliser dans les applications d’une seule page (SPA). (at.js 2.x)
