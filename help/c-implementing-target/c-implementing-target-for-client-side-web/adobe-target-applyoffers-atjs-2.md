---
description: 'Informations sur la fonction adobe. target. applyoffers (options) pour at. js. '
keywords: adobe.target.notification;élément;sélecteur;notification;extension
seo-description: Informations sur la fonction adobe. target. applyoffers (options) pour la bibliothèque JavaScript d'Adobe Target at. js.
seo-title: Informations sur la fonction adobe. target. applyoffers (options) pour la bibliothèque JavaScript d'Adobe Target at. js.
solution: Target
