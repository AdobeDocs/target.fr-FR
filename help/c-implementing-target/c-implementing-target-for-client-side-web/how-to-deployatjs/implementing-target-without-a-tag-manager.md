...
|Chargement de page activé (auto-create global mbox|Sélectionnez si vous souhaitez incorporer l’appel de mbox globale dans le fichier at.js pour qu’il se déclenche automatiquement à chaque chargement de page.|
