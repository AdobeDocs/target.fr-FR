...
description: Utilisez adobe.cible.sendNotifications() pour at.js pour envoyer des notifications au bord de la Cible lorsqu’une expérience est rendue sans appliquer applyOffer(s). (at.js.2.1 +)
