...
Pour implémenter [!DNL Adobe Target] le côté client, vous devez utiliser la bibliothèque at. js.
...
## Quelle différence y a-t-il entre les diagrammes de flux de tâches dans les diagrammes de workflow dֺ’At.js 1.*Schémas de flux de travaux x* et at. js 2. x ?

Voir [Mise à niveau de at. js 1. x vers at. js 2. x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md) pour plus d&#39;informations sur les différences introduites à la 2. O depuis 1.*x*.
...
* at. js 2. x gère les concepts d&#39;affichage qui sont utilisés pour les applications d&#39;une seule page. at.js 1.*x* n’a pas conscience de ce concept.
