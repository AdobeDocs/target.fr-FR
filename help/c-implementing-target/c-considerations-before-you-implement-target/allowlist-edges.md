...
description: Vue d’une liste d’hôtes pour vous aider à placer sur la liste autorisée les arêtes Adobe Target (noeuds de service répartis géographiquement qui garantissent un temps de réponse optimal aux utilisateurs finaux).
