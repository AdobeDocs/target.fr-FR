...
* Correction de problèmes empêchant les clients de se connecter au [!UICONTROL Compositeur d’expérience visuelle] (VEC) en raison de nouvelles stratégies de sécurité pour les cookies tiers dans certains navigateurs Web. Ce problème a été abordé dans &quot;Pages non chargées dans le Compositeur d’expérience visuelle (VEC) ou le Compositeur d’expérience amélioré (CEE) lors de l’utilisation de Google Chrome version 80+&quot; dans [Dépannage des problèmes liés au compositeur d’expérience visuelle et au compositeur d’expérience amélioré](/help/c-experiences/c-visual-experience-composer/r-troubleshoot-composer/issues-related-to-the-visual-experience-composer-vec-and-enhanced-experience-composer-eec.md).
* Correction d’un problème en raison duquel les noms d’offre dans le VEC affichaient le chemin d’accès de l’offre au lieu du nom convivial de l’offre. (TGT-41300)
* Les noms d’expérience sont désormais reflétés dans [!DNL Analysis Workspace] pour les activités A4T (TGT-38674)
* Correction d’un problème dans [!DNL Recommendations] qui a appliqué par erreur des modifications d&#39;ID d&#39;entité dans une promotion d&#39;une activité dupliquée à l&#39;activité d&#39;origine. (TGT-41482)
* Correction d’un problème qui empêchait le bouton &quot;Modifier les critères&quot; de s’afficher correctement sur le [!UICONTROL Expériences] page pour [!DNL Recommendations] activités dans le CEV. (TGT-39512)
* Correction d’un problème qui empêchait la synchronisation des activités lors de la duplication et de la copie dans un espace de travail de test. (TGT-40686)
* Correction d’un problème qui empêchait les modifications apportées à un sélecteur avec [fragments d’expérience](/help/c-experiences/c-manage-content/aem-experience-fragments.md) lors de l’utilisation de[!UICONTROL Insérer après]&quot; dans la VEC. (TGT-41802)
* Correction d’un problème qui empêchait l’envoi du contenu JSON vide dans une offre vers le serveur principal. [!DNL Target] envoie maintenant l’objet JSON même s’il est vide. (TGT-41555)
* Correction d’un problème à l’origine de l’héritage [!DNL Analytics] création de rapports à ouvrir au lieu de [!DNL Analysis Workspace] lorsque des clients ont cliqué sur &quot;[!UICONTROL Affichage dans Analytics]&quot; lors de l’affichage d’un rapport. (TGT-41867)
* Ajout d’une clarification supplémentaire au message d’interface utilisateur affiché lorsqu’un client tente de sélectionner [!DNL Analytics] comme source de déclaration (A4T) pour un [!UICONTROL Automated Personalization] activité. Le message indique : &quot;[!DNL Target] est la seule source prise en charge pour [!UICONTROL Automated Personalization] activités.&quot; (TGT-41954)
...
* Correction d’un problème en raison duquel certaines activités étaient &quot;[!UICONTROL Dernière mise à jour]&quot; date différente de l&#39;interface utilisateur en anglais pour les clients espagnols et japonais (lors de l&#39;affichage de l&#39;interface utilisateur en espagnol et en japonais). (TGT-38980)
...
* Correction dʼun problème en raison duquel lʼespace de travail par défaut était remplacé par un autre espace de travail lors de lʼactualisation de la page [!UICONTROL Audiences]. (TGT-38871)
* Correction dʼun problème dans [!UICONTROL Administration] > [!UICONTROL Mise en œuvre] qui entraînait parfois un message dʼerreur indiquant : « Il est possible que votre mbox globale ne soit pas synchronisée. Réessayez de lʼenregistrer ».
...
Les adresses IP des serveurs de traitement des flux de [!DNL Target Recommendations] ont été mises à jour le 16 mars 2021. Pour plus d’informations, voir [Adresses IP utilisées par les serveurs de traitement de flux de Recommendations](/help/c-recommendations/c-recommendations-faq/ip-addresses-marketing-cloud.md).
...
| --- | --- |
| Prise en charge d’Analytics for Target (A4T) pour les activités d’[!UICONTROL affectation automatique] | Les activités d’[!UICONTROL affectation automatique] prennent désormais en charge [Analytics for Target](/help/c-integrating-target-with-mac/a4t/a4t.md).<br>Cette intégration vous permet d’utiliser la fonctionnalité de bandit à plusieurs bras d’[!UICONTROL affectation automatique] pour orienter le trafic vers des expériences gagnantes, tout en utilisant une mesure d’objectif d’[!UICONTROL Adobe Analytics] et/ou des fonctionnalités de création de rapports et d’analyse d’[!UICONTROL Adobe Analytics].<br>Si vous avez déjà [implémenté A4T](/help/c-integrating-target-with-mac/a4t/a4timplementation.md) pour une utilisation avec les activités de test A/B et de ciblage d’expérience, vous avez terminé.<br>Pour plus d’informations, consultez [Prise en charge d’A4T pour les activités d’affectation automatique et de ciblage automatique](/help/c-integrating-target-with-mac/a4t/a4t-at-aa.md). |
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Auparavant, Target autorisait la dépendance à une mesure unique et cette mesure devait être atteinte pour que son décompte soit incrémenté. Vous avez désormais la possibilité de fournir une dépendance sur plusieurs mesures et choisir si la mesure doit être atteinte ou non pour que le décompte augmente. </p> <p>La fonctionnalité de dépendance à plusieurs mesures n’est pas prise en charge pour ce qui suit : </p> <p> 
     ...
     <ul id="ul_4B0EFFDD257C42579E19569DCBE15BE3"> 
      ...
      <li id="li_FB5E7CBC0154406C989F5A5C6CAA0C8F"> <p>Automated Personalization (AP) : <a href="/help/c-activities/t-automated-personalization/create-ap-activity.md#task_8AAF837796D74CF893CA2F88BA1491C9" format="dita" scope="local">Création d’une activité d’Automated Personalization </a> </p> </li> 
...
* Le sélectionneur déroulant aux emplacements suivants de l’interface utilisateur de Target a été remplacé par la fonctionnalité de saisie automatique afin d’améliorer la vitesse et les performances : (TGT-22939)
   ...
   * Recommendations > Création du flux > Quand type de source > Analyses > sélectionneur Suite de rapports
...
<table id="table_8525ECC9B6D0435ABEF8C27F747B7A0C"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Utilisez la logique AND/OR imbriquée quand vous configurez des audiences. </p> <p>Voir <a href="/help/c-target/c-audiences/create-audience.md#task_E18BD77A9A8F4ED0AC50569F94556558" format="dita" scope="local">Création d’une audience</a>. </p> </td> 
  </tr> 
  <tr> 
