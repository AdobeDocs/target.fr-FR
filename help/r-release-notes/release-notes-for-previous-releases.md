...
* Correction d’un problème en raison duquel les mesures incompatibles étaient sélectionnées dans les activités d’affectation automatique et d’Cible automatique qui utilisaient Analytics pour la Cible (A4t). (TGT-36646)
...
* Nous avons normalisé la liste des mesures disponibles à partir de Analytics pour les activités de Cible (A4T) en abandonnant les mesures Adobe Analytics qui ne sont pas prises en charge dans la version actuelle des API de Adobe Analytics. Cela nous permettra d’étendre notre prise en charge A4T dans les prochaines versions des Adobes Target.
...
La version de maintenance 20.1.1 de Target Standard/Premium comprend des améliorations et des améliorations du serveur principal. En outre, les correctifs suivants sont inclus :

* Correction d’un problème en raison duquel le champ Serveur de suivi Analytics Adobe d’était vide sur la page Objectifs et paramètres pour les activités existantes Adobe for Cible (A4T). (TGT-35960)
...
### Cible Java SDK version 1.1.0 (16 décembre 2019)
...
* Les notifications de Événement (icône représentant une cloche dans l’interface utilisateur de la Cible) ne sont plus disponibles. Une nouvelle recherche de notifications est bientôt disponible.
  ...
  <tr> 
   ...
   <td colname="col2"> <p> <span class="filepath"> at.js</span> version 0.9.6 est désormais disponible. Pour plus d’informations, voir <a href="../c-implementing-target/c-implementing-target-for-client-side-web/how-to-deployatjs/implementing-target-without-a-tag-manager.md#concept_1E1F958F9CCC4E35AD97581EFAF659E2" format="dita" scope="local">Téléchargement d’at.js</a>. </p> <p>Les améliorations et corrections suivantes sont incluses dans la version 0.9.6 d’<span class="filepath">at.js</span> : </p> <p> 
     <ul id="ul_108DF85393614C69988E299485D338FD"> 
      ...
      <li id="li_02904EBAE8D3400092B762F0B28B0C86"> <p>Correction d’un problème en raison duquel les modules externes de <span class="keyword">Target Classic</span> n’étaient pas correctement appliqués lorsque plusieurs offres par défaut étaient diffusées à une seule mbox. (TGT-22664)</p> </li> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>18 janvier 2017 </p> <p> La version 62 de <span class="codeph">mbox.js</span> contient les améliorations et correctifs suivants : </p> <p> 
     ...
     </ul> </p> <p>Pour en savoir plus sur les modifications apportées à chaque version de <span class="codeph">mbox.js</span>, voir <a href="https://docs.adobe.com/content/help/en/target/using/implement-target/client-side/mbox-implement/mboxjs-change-log.html" format="html" scope="external">Détails de la version mbox.js </a>. </p> </td> 
  </tr> 
 </tbody> 
</table>
...
<table id="table_907A952F54084C2A9C61F10E2B7A7BFF"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Affichez l’élément clé dans votre conception de recommandations. </p></td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> 
     <ul id="ul_E0D6A9C12B514DE3B3EA753BB4D56662"> 
      ...
      <li id="li_5B074C9FB3CB46EBA6EB4D8B1098480E"> Réindexation automatique horaire des catalogues de produits pour les clients sans flux </li> 
     </ul> </p> </td> 
  </tr> 
  <tr> 
...
* mbox.js version 56 a déplacé la section « Extra JavaScript » de sorte qu’elle est exécutée avant la mbox globale.
   ...
   Tous les paramètres dans v56+ sont espacés par nom. Si des fonctions sont déclarées dans la section « Extra JavaScript », elles doivent comporter le préfixe window. Voir [Journal des modifications de mbox.js](https://docs.adobe.com/content/help/en/target/using/implement-target/client-side/mbox-implement/mboxjs-change-log.html).
...
| Fonctionnalité | Description |
|---|---|
| Téléchargement de [!DNL mbox.js] depuis Target Standard | The [!DNL mbox.js] file can now be downloaded directly from **[!UICONTROL Administration]** > **[!UICONTROL Implementation]** in the Target Standard interface. Auparavant, le fichier devait être téléchargé depuis Target Advanced, ou être fourni par votre conseiller ou gestionnaire de compte. |
