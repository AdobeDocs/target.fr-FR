...
description: Cette page répertorie les modifications importantes apportées à la documentation Adobe Target, classées par versions.
...
## Adobe Target Standard/Premium 20.1.1 (4 février 2019)
...
|  | [Mise à niveau d’at.js 1.x vers at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#audience-parameters) | Ajout d’une nouvelle section : &quot;Quel at.js 1.*Les paramètres x* pour la création d’audiences ne sont pas pris en charge dans at.js 2.*x*?&quot; |
...
|  | [Notes de mise à jour de Target (actualisées)](/help/r-release-notes/release-notes.md) | Ajout d’informations sur la version 19.10.2 de Target Premium et la version du SDK Java Target. |
| 30 octobre 2019 | [Notes de mise à jour de Target (préliminaires)](/help/r-release-notes/target-release-notes.md) | Ajout d’informations à propos de la prochaine version de Target Premium 19.10.2 (31 octobre 2019). |
...
| 24 octobre 2019 | [Questions fréquentes relatives aux recommandations](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md#section_DB3F40673AED42228E407C05437D99E9) | Mise à jour du texte dans la FAQ suivante : &quot;Pourquoi Target est-il parfois incapable d’afficher des recommandations ?&quot; |
...
|  | [FAQ sur Target et les audiences](/help/c-target/c-troubleshooting-targets-and-audiences/troubleshooting-targets-and-audiences.md) | Ajout d’une nouvelle FAQ : &quot;Lors de la création de chaînes URL complexes, l’URL entière est-elle évaluée [!DNL Target] ?&quot; |
...
|  | [Résolution des problèmes liés aux activités](/help/c-activities/c-troubleshooting-activities/troubleshooting-activities.md) | Ajout d’une nouvelle section : &quot;J’ai créé une activité à l’aide de l’interface utilisateur de Target et je ne peux pas la mettre à jour via l’API.&quot; |
...
| 12 août 2019 | [Android - Configuration de l’application mobile](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer-android.md#sdk-library) | Mise à jour des informations sur les dépendances et les artefacts.<br>Mise à jour de l’exemple de code pour le fichier `AndroidManifest.XML`. |
|  | [Notes de mise à jour de Target (actualisées)](/help/r-release-notes/release-notes.md) | Mise à jour de la liste des améliorations et correctifs dans la section « SDK VEC Mobile Target iOS 2.1.0 et Android 1.1.1 ». |
|  | [Modification d’une activité ou enregistrement sous forme de version préliminaire](/help/c-activities/edit-activity.md#classic) | Ajout de la section suivante : « Utilisation des activités existantes créées dans Recommendations Classic ». |
...
| 6 août 2019 | [Notes de mise à jour de Target (actualisées)](/help/r-release-notes/release-notes.md) | Ajout de notes de mise à jour pour le SDK VEC Mobile Target iOS 2.1.0 et Android 1.1.0. |
...
|  | [Configuration du suivi des clics dans l’application mobile](/help/c-target-mobile-app/c-mobile-visual-experience-composer/set-up-click-tracking-in-the-mobile-vec.md) | Ajout d’informations sur le panneau Modifications qui affiche les éléments configurés pour le suivi des clics. |
...
|  | [Compositeur d’expérience visuelle pour application mobile](/help/c-target-mobile-app/c-mobile-visual-experience-composer/mobile-visual-experience-composer.md#ts) | Mise à jour de la section sur la résolution des problèmes pour indiquer que les restrictions de caractères ne s’appliquent plus aux noms des applications. Les restrictions s’appliquent uniquement aux ID. |
