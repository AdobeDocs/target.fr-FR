...
| Date | Rubrique | Modifications |
| --- | --- | --- |
| 29 janvier 2020 | [Personnalisation d’une conception à l’aide de Velocity](/help/c-recommendations/c-design-overview/customizing-a-template.md) | Mise à jour des exemples de texte et de code. Les nouveaux exemples de code montrent comment utiliser les nombres dans les modèles Velocity. |
| 28 janvier 2020 | [Notes de mise à jour de Target (préliminaires)](/help/r-release-notes/target-release-notes.md) | Modification de la date de publication de la version de Cible Standard/Premium 20.1.1. La date de publication est maintenant le 4 février 2020. |
...
|  | [Limites](/help/r-troubleshooting-target/target-limits.md) | Ajout des informations suivantes : &quot;Si vous utilisez l’API Diffusion par lot, la limite est de 50 mbox par demande de lot.&quot; |
...
| 23 janvier 2020 | [Interprétation des rapports d’affectation automatique](/help/c-activities/automated-traffic-allocation/determine-winner.md) | Ajout d’une note permettant d’utiliser le calculateur de taille d’échantillon d’Adobe Cible pour déterminer le gagnant. |
|  | [Attributs d’entité](/help/c-recommendations/c-products/entity-attributes.md) | Ajout d’une note expliquant que si vous utilisez at.js 2.*x*, `mboxCreate` n’est plus pris en charge. Pour transmettre des informations sur les produits ou le contenu à Recommendations à l’aide d’at.js 2.*x*, utilisez `targetPageParams`. |
| 22 janvier 2020 | [affectation automatique](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) | Mise à jour du FAQ suivant : &quot;Puis-je utiliser le calculateur de taille d’échantillon lors de l’affectation automatique pour estimer le temps que l’activité prendra pour identifier le gagnant ?&quot; |
...
|  | [Flux](/help/c-recommendations/c-products/feeds.md) | Ajout d’une remarque à propos du transfert et de la suppression d’entités et d’attributs d’entité. |
|  | [Questions fréquentes relatives aux recommandations](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md) | Ajout de la question fréquente suivante : Que signifie parfois la réponse NO_CONTENT renvoyée dans le suivi du contenu des recommandations ? |
|  | [Création d’une mbox de confirmation de commande - mbox.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/t-mbox-download/orderconfirm-create.md) | Ajout d’une note expliquant comment effectuer la confirmation de commande à l’aide d’at.js 2.*x*. |
| 9 janvier 2020 | [Modifications du chiffrement de TLS (Transport Layer Security)](/help/c-implementing-target/c-considerations-before-you-implement-target/tls-transport-layer-security-encryption.md) | Mise à jour du texte.<br>Après le 1er mars 2020, Adobe Cible ne prendra plus en charge le chiffrement TLS 1.1 pour le compositeur d’expérience visuelle (VEC), le compositeur d’expérience amélioré (CEE), la diffusion d’activité, les API, etc. Veuillez effectuer la mise à niveau vers TLS 1.2 avant le 1er mars 2020 pour éviter tout problème. |
...
| 19 décembre 2019 | [Notes de mise à jour - Cible Java SDK](/help/c-implementing-target/c-api-and-sdk-overview/releases-target-java-sdk.md) | Ajout d’informations relatives à version 1.1.0. |
...
|  | [Interprétation des rapports d’affectation automatique](/help/c-activities/automated-traffic-allocation/determine-winner.md) | Rubrique renommée et ajout de la section suivante : &quot;Comprendre l’effet élévateur et le rapports de confiance dans les activités d’affectation automatique.&quot; |
| 11 décembre 2019 | [FAQ sur le ciblage et les audiences](/help/c-target/c-troubleshooting-targets-and-audiences/troubleshooting-targets-and-audiences.md) | Ajout d’une nouvelle FAQ : &quot;Comment la Cible évalue-t-elle les URL dans le ciblage ?&quot; |
| 10 décembre 2019 | [Limites de Cible](/help/r-troubleshooting-target/target-limits.md) | Mise à jour de la section des paramètres de mbox. |
|  | [Critères](/help/c-recommendations/c-algorithms/algorithms.md) | Ajout d’une remarque à propos de la prise en charge de la fonction Utilisation des critères. |
...
|  | [newsletter Cible Insider](/help/r-release-notes/target-insider-newsletter.md) | Ajout d’un lien vers la newsletter de novembre 2019. |
...
| 11 novembre 2019 | [Notes de mise à jour - Cible Java SDK](/help/c-implementing-target/c-api-and-sdk-overview/releases-target-java-sdk.md) | Ajout d’informations relatives à version 1.0.1. |
...
|  | [Géo](/help/c-target/c-audiences/c-target-rules/geo.md#section_DD308A53AF0F48FA8C81423580561FE7) | Ajout d’informations expliquant que [!DNL Target] les informations géographiques ne sont pas stockées, telles que les codes postaux. |
| 8 novembre 2019 | [newsletter Cible Insider](/help/r-release-notes/target-insider-newsletter.md) | Ajout de liens vers d’autres problèmes antérieurs. |
|  | [Réglementations relatives à la confidentialité et à la protection des données](/help/c-implementing-target/c-considerations-before-you-implement-target/c-privacy/cmp-privacy-and-general-data-protection-regulation.md) | Mise à jour de la section de l&#39;ACCP avec une nouvelle note.<br>Ajout d’une nouvelle FAQ informant les clients que la Cible n’est pas en mesure de permettre aux clients de partager ou de vendre directement des données de Cible à des tiers, de sorte qu’il n’y a pas de opt-out de vente pour la Cible. |
...
|  | [Notes de mise à jour - Cible Java SDK](/help/c-implementing-target/c-api-and-sdk-overview/releases-target-java-sdk.md) | Nouvelle rubrique. |
|  | [Mise à niveau d’at.js 1.x vers at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/upgrading-from-atjs-1x-to-atjs-20.md#audience-parameters) | Ajout d’une nouvelle section : &quot;Lequel at.js 1.*Les paramètres x* pour la création d’audiences ne sont pas pris en charge dans at.js 2.*x*?&quot; |
...
|  | [Notes de mise à jour de Target (actualisées)](/help/r-release-notes/release-notes.md) | Ajout d’informations à propos de la version 19.10.2 de Cible Premium et de la version du SDK Java Cible. |
| 30 octobre 2019 | [Notes de mise à jour de Target (préliminaires)](/help/r-release-notes/target-release-notes.md) | Ajout d’informations sur la prochaine version de Cible Premium 19.10.2 (31 octobre 2019). |
| 29 octobre 2019 | [similarité de contenu](/help/c-recommendations/c-algorithms/create-new-algorithm.md#concept_5402DAFA279C4E46A9A449526889A0CB) | Ajout d’une remarque. |
|  | [Prévisualisation et lancement de votre activité de recommandations](/help/c-recommendations/t-create-recs-activity/previewing-and-launching-your-recommendations-activity.md) | Nouvelle rubrique. |
...
|  | [adobe.target.getOffers(options) - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Ajout d’un lien vers la documentation de l’API de la Diffusion de Cibles afin de vous aider à comprendre les types disponibles pour les requêtes/réponses (tableau, chaîne, etc.). |
|  | [adobe.target.getOffers(options) - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Ajout d’un lien vers la documentation de l’API de la Diffusion de Cibles afin de vous aider à comprendre les types disponibles pour les requêtes/réponses (tableau, chaîne, etc.). |
|  | [Pages du site](/help/c-target/c-audiences/c-target-rules/site-pages.md#ts) | Ajout de la section &quot;Dépannage&quot;. |
| 24 octobre 2019 | [Questions fréquentes relatives aux recommandations](/help/c-recommendations/c-recommendations-faq/recommendations-faq.md#section_DB3F40673AED42228E407C05437D99E9) | Mise à jour du texte dans la FAQ suivante : &quot;Pourquoi la Cible est-elle parfois incapable de présenter des recommandations ?&quot; |
|  | [Problèmes connus et problèmes résolus](/help/r-release-notes/known-issues-resolved-issues.md#atjs) | Ajout d’une note à un problème connu qui affecte les versions antérieures d’at.js (antérieures à la version 2.2.0). |
|  | [Mesures de succès](/help/c-activities/r-success-metrics/success-metrics.md) | Ajout d’une remarque sur le comportement par défaut des mesures de réussite pour les activités utilisant A4T. |
| 22 octobre 2019 | [Critères/algorithmes](/help/c-recommendations/c-algorithms/algorithms.md#criteria-algorithms) | Ajout d’une ligne pour les recommandations basées sur l’utilisateur. |
|  | [Critères](/help/c-recommendations/c-algorithms/algorithms.md#custom-key) | Ajout d’une nouvelle section : &quot;Utilisation d’une clé de recommandations personnalisée.&quot; |
|  | [FAQ sur les Cibles et les audiences](/help/c-target/c-troubleshooting-targets-and-audiences/troubleshooting-targets-and-audiences.md) | Ajout d’une nouvelle FAQ : &quot;Lors de la création de chaînes d’URL complexes, l’URL complète est-elle évaluée [!DNL Target] ?&quot; |
|  | [Notes de mise à jour](/help/r-release-notes/release-notes.md) : 19.10.1 | Cette version comprend des améliorations et des correctifs. Vous pouvez les lire et les lier à la documentation depuis les notes de mise à jour. Cette version inclut également de nombreuses mises à jour de la documentation dans l’ensemble de l’aide. |

## Adobe Cible/Standard/Premium 19.9.1 (30 septembre 2019)

| Date | Rubrique | Modifications |
| --- | --- | --- |
| 17 octobre 2019 | [AQ d’activité](/help/c-activities/c-activity-qa/activity-qa.md) | Mise à jour de la rubrique afin d’expliquer comment l’assurance qualité des Activités fonctionne avec les cookies tiers. |
...
|  | [Notes de mise à jour de Target (actualisées)](/help/r-release-notes/release-notes.md) | Ajout d’informations sur les versions at.js 2.2 et at.js 1.8. |
|  | [Informations détaillées sur les versions du fichier at.js](/help/c-implementing-target/c-implementing-target-for-client-side-web/target-atjs-versions.md) | Ajout d’informations sur les versions at.js 2.2 et at.js 1.8. |
|  | [Résolution des problèmes liés aux activités](/help/c-activities/c-troubleshooting-activities/troubleshooting-activities.md) | Ajout d’une nouvelle section : &quot;J’ai créé une activité à l’aide de l’interface utilisateur de la Cible et je ne peux pas la mettre à jour via l’API.&quot; |
...
|  | [Notes de mise à jour - API côté serveur de Cible](/help/c-implementing-target/c-api-and-sdk-overview/releases-server-side.md) | Nouvelle rubrique. |
|  | [Notes de mise à jour - SDK Node.js Cible](/help/c-implementing-target/c-api-and-sdk-overview/releases-nodejs.md) | Nouvelle rubrique. |
|  | [Notes de mise à jour de Target (actualisées)](/help/r-release-notes/release-notes.md) | Ajout d’informations sur les versions de l’API V1/Diffusion et du SDK Node.js. |
| 8 octobre 2019 | [newsletter Cible Insider](/help/r-release-notes/target-insider-newsletter.md) | Nouvelle rubrique avec des liens vers le premier lot de bulletins d&#39;information, avec d&#39;autres à venir. |
| 3 octobre 2019 | [Problèmes connus et problèmes résolus](/help/r-release-notes/known-issues-resolved-issues.md) | Ajout des éléments suivants : <ul><li>Problème connu et solution de contournement lors de la création d’une expérience sans modification à l’aide d’at.js 2.*bibliothèque x* .</li><li>Les collections, exclusions, critères et conceptions créés par le biais de l’API ne sont pas visibles dans l’interface utilisateur Target et ne peuvent être modifiés que par le biais de l’API.</li><li>Les activités de recommandations créées par l’intermédiaire de l’API peuvent être visualisées dans l’interface utilisateur, mais ne peuvent être modifiées qu’au moyen de l’API.</li></ul> |
|  | [Résolution des problèmes liés à la diffusion de contenu](/help/c-activities/c-troubleshooting-activities/content-trouble.md#mboxdebug) | Ajout d’une remarque à la section &quot;mboxDebug&quot;. |
...
|  | [adobe.target.getOffers(options) - at.js 2.x](/help/c-implementing-target/c-implementing-target-for-client-side-web/adobe-target-getoffers-atjs-2.md) | Exemple de code mis à jour dans la section &quot;Call getOffers() for all vues&quot;. |
...
| Date | Rubrique | Modifications |
| --- | --- | --- |
| 27 septembre 2019 | [Quelle doit être la durée d’exécution d’un test A/B ?](/help/c-activities/t-test-ab/sample-size-determination.md) | Mise à jour du texte sur le calculateur de taille d’échantillon de Cible. |
|  | [affectation automatique](/help/c-activities/automated-traffic-allocation/automated-traffic-allocation.md) | Mise à jour du texte sur le calculateur de taille d’échantillon de Cible. |
| 24 septembre 2019 | [Notes de mise à jour de Target (préliminaires)](/help/r-release-notes/target-release-notes.md) | Date de publication de la version 19.2.1 de Cible/Standard modifiée au 30 septembre 2019. |
|  | [Recommandations en tant qu’offre](/help/c-recommendations/recommendations-as-an-offer.md) | Ajout d’une vidéo de formation. |
| 10 septembre 2019 | [Notes de mise à jour de Target (actualisées)](/help/r-release-notes/release-notes.md) | Ajout d’informations sur la version de Cible Standard/Premium 19.9.1. |
...
| 6 septembre 2019 | [Notes de mise à jour de Target (préliminaires)](/help/r-release-notes/target-release-notes.md) | Ajout d’informations sur la version de Cible Standard/Premium 19.9.1 (10 septembre 2019). |
|  | [FAQ sur la Cible pour les applications mobiles](/help/c-target-mobile-app/target-for-mobile-apps-faq.md) | Nouvelle rubrique. |
...
| 8 juillet 2019 | [CNAME et Adobe Target](/help/c-implementing-target/c-considerations-before-you-implement-target/implement-cname-support-in-target.md) | Ajout d’informations expliquant pourquoi vous devez utiliser CNAME. |
