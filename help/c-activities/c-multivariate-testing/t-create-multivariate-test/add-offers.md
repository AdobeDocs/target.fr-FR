...
description: Découvrez comment utiliser le compositeur d’expérience visuelle (VEC) en Adobe Target pour créer les offres à inclure dans votre test multivarié (MVT).
