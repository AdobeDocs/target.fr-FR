...
description: Découvrez comment utiliser le compositeur d’expérience visuelle dans Adobe [!DNL Target] pour créer une activité de ciblage d’expérience sur une page compatible avec les Cibles.
