...
Pour afficher une page différente une fois le compositeur d’expérience visuelle ouvert, cliquez sur **[!UICONTROL Configurer]**, sélectionnez **[!UICONTROL URL]**, puis saisissez l’URL dans le champ URL d’activité.
