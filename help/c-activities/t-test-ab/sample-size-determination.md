...
description: Découvrez la durée d’exécution d’un test A/B. Un test A/B réussi en Adobe Target nécessite un nombre suffisant de visiteurs (taille de l’échantillon) pour améliorer votre taux de conversion.
