...
1. Spécifiez le canal souhaité : Web.

   Vous pouvez également sélectionner les options Application mobile, courrier électronique ou Autre/API.

1. Pour utiliser le compositeur d’expérience visuelle (VEC), cliquez sur **[!UICONTROL Visuel (par défaut)]**.

   Si vous préférez utiliser le compositeur d’expérience d’après les formulaires, sélectionnez l’option **[!UICONTROL Formulaire]**.
...
1. Modifiez les éléments de la page comme expliqué dans la section [Expériences](../../c-experiences/experiences.md#concept_A2E10F6AFB3D4AEAB6951EE14688848D), puis cliquez sur **[!UICONTROL Suivant]**.
...
1. Cliquez sur **[!UICONTROL Gérer le contenu]** pour configurer les combinaisons disponibles.
   ...
   La liste [!UICONTROL Expériences] affiche chaque élément de contenu sélectionné pour l’activité ainsi que l’emplacement auquel il est affecté. Vous pouvez exclure certaines expériences en survolant l’expérience souhaitée, puis en cliquant sur l’icône Exclure, ou bien exclure ou inclure des expériences par lots en cochant la case correspondant aux expériences pertinentes, puis en cliquant sur l’icône Exclure dans le coin supérieur droit de la boîte de dialogue.
...
1. Cliquez sur **[!UICONTROL Offres]** pour sélectionner des portions de contenu et les affecter à des [groupes de génération de rapports](../../c-reports/offer-reporting-groups-in-automated-personalization.md#concept_194128C0B56B4B26AAB57DB49892960C).
   ...
   Vous pouvez ajouter des expériences spécifiques à un groupe de génération de rapports en survolant l’offre souhaitée, puis en cliquant sur l’icône de dossier, ou bien inclure des expériences par lots dans un groupe de génération de rapports en cochant la case correspondant aux expériences pertinentes, puis en cliquant sur l’icône de dossier du groupe dans le coin supérieur droit de la boîte de dialogue.
...
1. (Conditionnel) Cliquez sur **[!UICONTROL Offres]** pour sélectionner des éléments de contenu et les affecter aux groupes de génération de rapports ou uniquement autoriser certains visiteurs à voir certaines offres avec le ciblage.
   ...
   Pour plus d’informations sur le ciblage d’une offre sur des audiences spécifiques, voir [Offres de personnalisation automatisée de Target](../../c-activities/t-automated-personalization/ap-target-offers.md#task_F207ED7A41B84FD39BB6FCBFABF4B23E).
1. (Conditionnel) Cliquez sur **[!UICONTROL Groupes d’exclusion]** pour choisir une combinaison d’éléments à exclure de l’activité.

   ![Résultat de l’étape](assets/exclusion_groups.png)
...
1. **Cliquez sur[!UICONTROL Suivant]** lorsque vous avez terminé de configurer le contenu de votre activité.
...
1. Cliquez sur **[!UICONTROL Continuer]** pour afficher la page **[!UICONTROL Objectifs et paramètres.]**.
